var jsKeyboardCurrentElementCursorPosition = 0;
...
var jsKeyboard = {
    ...
    init: function (elem, keyboard) {
        ...
        jsKeyboard.keyboard["swe"] = jsKeyboard.sweKeyboard;
        ...
        $(':input').not('[type="reset"]').not('[type="submit"]').on('focus, click', function (e) {
            ...
            jsKeyboardCurrentElementCursorPosition = $(this).getCursorPosition();
            if (jsKeyboard.currentElementCursorPosition == -1) {
                jsKeyboard.currentElementCursorPosition = 0;
                jsKeyboardCurrentElementCursorPosition = 0;
            }
    ...
    changeToSmallLetter: function () {
        $("#keyboardCapitalLetter,#keyboardNumber,#keyboardSymbols,#keyboardSmallLetter").css("display", "block");
    ...
    changeToCapitalLetter: function () {
        $("#keyboardSmallLetter,#keyboardNumber,#keyboardSymbols,#keyboardCapitalLetter").css("display", "block");
    ...
    changeToNumber: function () {
        ...
        $("#keyboardSymbols,#keyboardCapitalLetter,#keyboardSmallLetter,#keyboardNumber").css("display", "block");
        $("#keyboardSymbols,#keyboardCapitalLetter,#keyboardSmallLetter").css("display", "none");
    },
    changeToSymbols: function () {
        $("#keyboardCapitalLetter,#keyboardNumber,#keyboardSmallLetter,#keyboardSymbols").css("display", "block");
    ...
    updateCursor: function () {
        ...
        jsKeyboard.currentElement.setCursorPosition(jsKeyboardCurrentElementCursorPosition);
    },
    write: function (m) {
        var a = jsKeyboard.currentElement.val(),
            b = String.fromCharCode(m),
            //pos = jsKeyboard.currentElementCursorPosition,
            pos = jsKeyboardCurrentElementCursorPosition,
        ...
        jsKeyboardCurrentElementCursorPosition++;
        jsKeyboard.updateCursor();
    },
    //getCursorPosition: function () {     
    //    jsKeyboard.currentElementCursorPosition = document.getElementById('ctl00_ShareEnterYourEmail').selectionStart;        
    //},
    del: function () {
        //if (document.getElementById('ctl00_ShareEnterYourEmail').selectionStart > 0) {
        //    var a = jsKeyboard.currentElement.val(),
        //        //pos = jsKeyboard.currentElementCursorPosition,
        //        pos = document.getElementById('ctl00_ShareEnterYourEmail').selectionStart,
        //        output = [a.slice(0, pos - 1), a.slice(pos)].join('');
        //    jsKeyboard.currentElement.val(output);
        //    jsKeyboard.currentElementCursorPosition--; //-1 cursor
        //    if (jsKeyboard.currentElementCursorPosition < 0) jsKeyboard.currentElementCursorPosition = 0;
        //    jsKeyboard.updateCursor();
        //}
        ...
        jsKeyboardCurrentElementCursorPosition--;
        //if (jsKeyboard.currentElementCursorPosition < 0) jsKeyboard.currentElementCursorPosition = 0;
        if (jsKeyboardCurrentElementCursorPosition < 0) jsKeyboardCurrentElementCursorPosition = 0;
        jsKeyboard.updateCursor();
    ...
    sweKeyboard: {
        capitalLetter:
            [
                // 1st row
                { value: 81 }, { value: 87 }, { value: 69 }, { value: 82 }, { value: 84 }, { value: 89 },
                { value: 85 }, { value: 73 }, { value: 79 }, { value: 80 }, { value: 197 },
                { value: "Delete", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "button button_del", keyClass: "key key_del" },
                // 2nd row
                { value: 65, buttonClass: "button button_a" }, { value: 83 }, { value: 68 }, { value: 70 },
                { value: 71 }, { value: 72 }, { value: 74 }, { value: 75 }, { value: 76 }, { value: 196 }, { value: 214 },
                { value: "Enter", isChar: "false", buttonClass: "button button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
                // 3rd row
                { value: "abc", isChar: "false", buttonClass: "button button_smallletter", onclick: "jsKeyboard.changeToSmallLetter();", keyClass: "key key_smallletter" },
                { value: 90 }, { value: 88 }, { value: 67 }, { value: 86 }, { value: 66 }, { value: 78 },
        ...
        smallLetter: [
            // 1st row
            { value: 113 }, { value: 119 }, { value: 101 }, { value: 114 }, { value: 116 },
            { value: 121 }, { value: 117 }, { value: 105 }, { value: 111 }, { value: 112 }, { value: 229 },
            { value: "Delete", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "button button_del", keyClass: "key key_del" },
            // 2nd row
            { value: 97, buttonClass: "button button_a" }, { value: 115 }, { value: 100 }, { value: 102 },
            { value: 103 }, { value: 104 }, { value: 106 }, { value: 107 }, { value: 108 }, { value: 228 }, { value: 246 },
            { value: "Enter", isChar: "false", buttonClass: "button button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
            // 3rd row
            { value: "ABC", isChar: "false", buttonClass: "button button_capitalletterleft", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
            { value: 122 }, { value: 120 }, { value: 99 }, { value: 118 }, { value: 98 },
...
jQuery.fn.getSelectionStart = function () {
    try {
        ...
        if (!input.selectionStart) return -1;

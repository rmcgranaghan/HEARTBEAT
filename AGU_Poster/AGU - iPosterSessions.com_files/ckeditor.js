...
(function () {
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, e) {
            ...
            }, moveToPosition: function (a, b) { this.setStartAt(a, b); this.collapse(!0) }, moveToRange: function (a) { this.setStart(a.startContainer, a.startOffset); this.setEnd(a.endContainer, a.endOffset) }, selectNodeContents: function (a) { this.setStart(a, 0); this.setEnd(a, a.type == CKEDITOR.NODE_TEXT ? a.getLength() : a.getChildCount()) }, setStart:
                function (b, c) {
                    try {
    ...
    CKEDITOR.config = { customConfig: ckeditorConfig, autoUpdateElement: !0, language: "", defaultLanguage: "en", contentsLangDirection: "", enterMode: CKEDITOR.ENTER_P, forceEnterMode: !1, shiftEnterMode: CKEDITOR.ENTER_BR, docType: "\x3c!DOCTYPE html\x3e", bodyId: "", bodyClass: "", fullPage: !1, height: 200, contentsCss: CKEDITOR.getUrl("contents.css"), extraPlugins: "", removePlugins: "", protectedSource: [], tabIndex: 0, width: "", baseFloatZIndex: 1E4, blockedKeystrokes: [CKEDITOR.CTRL + 66, CKEDITOR.CTRL + 73, CKEDITOR.CTRL + 85] };
    (function () {
    ...
    (function () {
        function a(a, e, f) {
            ...
            b) { return b == CKEDITOR.ELEMENT_MODE_INLINE ? a.is(CKEDITOR.dtd.$editable) || a.is("textarea") : b == CKEDITOR.ELEMENT_MODE_REPLACE ? !a.is(CKEDITOR.dtd.$nonBodyContent) : 1 } function c() { var a = this.commands, b; for (b in a) e(this, a[b]) } function e(a, b) { b[b.startDisabled ? "disable" : a.readOnly && !b.readOnly ? "disable" : b.modes[a.mode] ? "enable" : "disable"]() } function g(a, b, c) { if (b) { var d, e, l = a.commands; for (e in l) d = l[e], (c || d.contextSensitive) && d.refresh(a, b) } } function k(a) {
                ...
                }, setReadOnly: function (a) { a = null == a || a; this.readOnly != a && (this.readOnly = a, this.keystrokeHandler.blockedKeystrokes[8] = +a, this.editable().setReadOnly(a), this.fire("readOnly")) },
                insertHtml: function (a, b, c) {
                    this.fire("insertHtml", { dataValue: a, mode: b, range: c })
                }, insertText: function (a) { this.fire("insertText", a) }, insertElement: function (a) { this.fire("insertElement", a) }, getSelectedHtml: function (a) {
    ...
    (function () {
        ...
        z = CKEDITOR.dom.walker.bogus(); y = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi; m = function () {
            function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                ...
                function d(b, c) { if (c.isBlock && c.isElement && !c.node.is("br") && a(b) && b.is("br")) return b.remove(), 1 } var e = c.endContainer.getChild(c.endOffset), f = c.endContainer.getChild(c.endOffset - 1); e && d(e, b[b.length - 1]); f && d(f, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1), c.collapse())
            ...
            return function (m, v, G, E) {
                ...
                if (!E.checkReadOnly()) {
                    var L = (new CKEDITOR.dom.elementPath(E.startContainer, E.root)).blockLimit || E.root; m = {
                        type: v, dontFilter: K, editable: m, editor: I, range: E, blockLimit: L, mergeCandidates: [], zombies: []
                    };
                    v = m.range;
                    E = m.mergeCandidates;
                    var H, u;
                    "text" == m.type && v.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) &&
                        (H = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", v.document), v.insertNode(H),
                            v.setStartAfter(H));
                    ...
                    if (!v.collapsed) {
                        ...
                        (u = e(v)) && a(u) && u.isBlockBoundary() && K.contains(u);
                    ...
                    if (H = G) {
                        ...
                        if ("text" == m.type && m.inlineStylesRoot) {
                            ...
                            for (E = m.inlineStylesRoot.getParent();
                                !u.equals(E);
                        ...
                        if ((z = H.startPath().block) && (1 != z.getChildCount() || !z.getBogus())) a: {
                            ...
                            if (1 ==
                                ...
                                for (E = z.count();
                                    H < E;
                                    H++)if (v = z.getItem(H), !v.is(x)) break a;
                                ...
                                if (I && L.isElement) {
                                    ...
                                    for (F = null;
                                        ...
                                        for (var U = [], aa = F.length, ba = 0, da = void 0,
                                            ea = 0, W = -1;
                                            ba < aa;
                                            ba++)da = F[ba], " " == da ? (ea || Y && !ba || (U.push(new CKEDITOR.dom.text(" ")), W = U.length), ea = 1) : (U.push(da), ea = 0);
                                        y && W == U.length && U.pop();
                                        Y = U
                                    }
                                } if (Y) {
                    ...
                    for (Y = O.createBookmark();
                        N = m.zombies.pop();
                    )N.getParent() && (V = O.clone(), V.moveToElementEditStart(N), V.removeEmptyBlocksAtEnd());
                    if (J) for (;
                        N = J.pop();
                    )CKEDITOR.env.needsBrFiller ? N.appendBogus() : N.append(O.document.createText(" "));
                    for (;
                        N = m.mergeCandidates.pop();
                    )N.mergeSiblings();
                    O.moveToBookmark(Y);
                    if (!m.dontMoveCaret) {
                        for (N = e(O);
...
*/
            ...
            var h = function (b) { this._ || (this._ = {}); this._["default"] = this._.initValue = b["default"] || ""; this._.required = b.required || !1; for (var a = [this._], d = 1; d < arguments.length; d++)a.push(arguments[d]); a.push(!0); CKEDITOR.tools.extend.apply(CKEDITOR.tools, a); return this._ }, v = { build: function (b, a, d) { return new CKEDITOR.ui.dialog.textInput(b, a, d) } }, n = { build: function (b, a, d) { return new CKEDITOR.ui.dialog[a.type](b, a, d) } }, q = {
                ...
                labeledElement: function (b, a, d, f) {
                    ...
                    if (arguments.length) {
                        ...
                        }, this); var c = CKEDITOR.tools.extend({}, a); delete c.style; var e = CKEDITOR.tools.getNextId() + "_label";
                        CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "a", null, {
                            style: a.style,
                            href: "javascript:void(0)",
                            title: a.label, hidefocus: "true", "class": a["class"], role: "button", "aria-labelledby": e
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                            ...
                            return '\x3cdiv class\x3d"dropzone"\x3e\x3c/div\x3e' + b.join("")
                        })
                    }
    ...
    //(function () {
    //    var d = /^(https?|ftp):\/\/(-\.)?([^\s\/?\.#-]+\.?)+(\/[^\s]*)?[^\s\.,]$/ig, e = /"/g;

    //    CKEDITOR.plugins.add("autolink", { requires: "clipboard", init: function (c) { c.on("paste", function (b) { var a = b.data.dataValue; b.data.dataTransfer.getTransferType(c) == CKEDITOR.DATA_TRANSFER_INTERNAL || -1 < a.indexOf("\x3c") || (a = a.replace(d, '\x3ca href\x3d"' + a.replace(e, "%22") + '"\x3e$\x26\x3c/a\x3e'), a != b.data.dataValue && (b.data.type = "html"), b.data.dataValue = a) }) } })
    //})();
    ...
    //        requires: "autolink,undo", init: function (a) {
    //            var g = 1, b; a.on("paste", function (c) {
    ...
    //                }
    //            }, null, null, 20); a.on("afterPaste", function () { b && p(a, g); })
    //        }
    //    });
    //    CKEDITOR.plugins.autoEmbed = {
    //        getWidgetDefinition: function (a, g) { var b = a.config.autoEmbed_widget || "embed,embedSemantic", c, d = a.widgets.registered; if ("string" == typeof b) for (b = b.split(","); c = b.shift();) { if (d[c]) return d[c] } else if ("function" == typeof b) return d[b(g)]; return null }
    //    }
    //})();
    ...
    CKEDITOR.config.coreStyles_superscript = { element: "sup" }; (function () {
        ...
        function p(a) { this.editor = a; this.registered = {}; this.instances = {}; this.selected = []; this.widgetHoldingFocusedEditable = this.focused = null; this._ = { nextId: 0, upcasts: [], upcastCallbacks: [], filters: {} }; F(this); G(this); this.on("checkWidgets", H); this.editor.on("contentDomInvalidated", this.checkWidgets, this); I(this); J(this); K(this); L(this); M(this) } function g(a, b, c, d, e) {
            ...
            }, !0); a.fire("instanceCreated", this); N(this, d); this.init && this.init(); this.inited = !0; (a = this.element.data("cke-widget-data")) && this.setData(JSON.parse(decodeURIComponent(a))); e && this.setData(e); this.data.classes || this.setData("classes",
            ...
            function c(b, d, c) {
                var e = CKEDITOR.tools.getIndex(a._.upcasts, function (a) {
                    return a[2] >
                        c
                }); 0 > e && (e = a._.upcasts.length); a._.upcasts.splice(e, 0, [b, d, c])
            } var d = b.upcast, e = b.upcastPriority || 10; if (d) if ("string" == typeof d) for (d = d.split(","); d.length;)c(b.upcasts[d.pop()], b.name, e); else c(d, b.name, e)
        } function t(a, b) { a.focused = null; if (b.isInited()) { var c = b.editor.checkDirty(); a.fire("widgetBlurred", { widget: b }); b.setFocused(!1); !c && b.editor.resetDirty() } } function H(a) {
            a = a.data; if ("wysiwyg" == this.editor.mode) {
                var b = this.editor.editable(), c = this.instances, d, e, f, h; if (b) {
                    for (d in c) c[d].isReady() &&
                        !b.contains(c[d].wrapper) && this.destroy(c[d], !0); if (a && a.initOnlyNew) c = this.initOnAll(); else { var l = b.find(".cke_widget_wrapper"), c = []; d = 0; for (e = l.count(); d < e; d++) { f = l.getItem(d); if (h = !this.getByElement(f, !0)) { a: { h = Q; for (var k = f; k = k.getParent();)if (h(k)) { h = !0; break a } h = !1 } h = !h } h && b.contains(f) && (f.addClass("cke_widget_new"), c.push(this.initOn(f.getFirst(g.isDomWidgetElement)))) } } a && a.focusInited && 1 == c.length && c[0].focus()
                }
            }
        } function u(a, b, c) {
            if (!c.allowedContent) return null; var d = this._.filters[a];
            d || (this._.filters[a] = d = {}); (a = d[b]) || (d[b] = a = new CKEDITOR.filter(c.allowedContent)); return a
        } function R(a) {
            var b = [], c = a._.upcasts, d = a._.upcastCallbacks; return {
                toBeWrapped: b, iterator: function (a) {
                    var f, h, l, k, m; if ("data-cke-widget-wrapper" in a.attributes) return (a = a.getFirst(g.isParserWidgetElement)) && b.push([a]), !1; if ("data-widget" in a.attributes) return b.push([a]), !1; if (m = c.length) {
                        if (a.attributes["data-cke-widget-upcasted"]) return !1; k = 0; for (f = d.length; k < f; ++k)if (!1 === d[k](a)) return; for (k = 0; k < m; ++k)if (f =
            ...
            if (a.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (d && !d[c.name]) { var d = a.split(b), e = a.parent; b = d.getIndex(); a.children.length || (--b, a.remove()); d.children.length || d.remove(); return w(e, b, c) }
            } a.add(c, b)
        } function x(a, b) { return "boolean" == typeof a.inline ? a.inline : !!CKEDITOR.dtd.$inline[b] } function Q(a) { return a.hasAttribute("data-cke-temp") } function n(a, b, c, d) {
            var e = a.editor; e.fire("lockSnapshot"); c ? (d = c.data("cke-widget-editable"), d = b.editables[d], a.widgetHoldingFocusedEditable = b, b.focusedEditable = d, c.addClass("cke_widget_editable_focused"), d.filter &&
                e.setActiveFilter(d.filter), e.setActiveEnterMode(d.enterMode, d.shiftEnterMode)) : (d || b.focusedEditable.removeClass("cke_widget_editable_focused"), b.focusedEditable = null, a.widgetHoldingFocusedEditable = null, e.setActiveFilter(null), e.setActiveEnterMode(null, null)); e.fire("unlockSnapshot")
        } function S(a) { a.contextMenu && a.contextMenu.addListener(function (b) { if (b = a.widgets.getByElement(b, !0)) return b.fire("contextMenu", {}) }) } function T(a, b) { return CKEDITOR.tools.trim(b) } function L(a) {
            var b = a.editor, c = CKEDITOR.plugins.lineutils;
            b.on("dragstart", function (d) { var c = d.data.target; g.isDomDragHandler(c) && (c = a.getByElement(c), d.data.dataTransfer.setData("cke/widget-id", c.id), b.focus(), c.focus()) }); b.on("drop", function (d) {
                        ...
                        lookups: {
                            "default": function (b) {
                                if (!b.is(CKEDITOR.dtd.$listItem) && b.is(CKEDITOR.dtd.$block) && !g.isDomNestedEditable(b) && !a._.draggedWidget.wrapper.contains(b)) {
                                    var c = g.getNestedEditable(d, b); if (c) {
                                        b = a._.draggedWidget; if (a.getByElement(c) ==
                                            b) return; c = CKEDITOR.filter.instances[c.data("cke-filter")]; b = b.requiredContent; if (c && b && !c.check(b)) return
            ...
            var b = a.editor; b.on("contentDom", function () {
                var c = b.editable(), d = c.isInline() ? c : b.document, e, f; c.attachListener(d,
                    "mousedown", function (c) { var d = c.data.getTarget(); if (!d.type) return !1; e = a.getByElement(d); f = 0; e && (e.inline && d.type == CKEDITOR.NODE_ELEMENT && d.hasAttribute("data-cke-widget-drag-handler") ? (f = 1, a.focused != e && b.getSelection().removeAllRanges()) : g.getNestedEditable(e.wrapper, d) ? e = null : (c.data.preventDefault(), CKEDITOR.env.ie || e.focus())) }); c.attachListener(d, "mouseup", function () { f && e && e.wrapper && (f = 0, e.focus()) }); CKEDITOR.env.ie && c.attachListener(d, "mouseup", function () {
                        setTimeout(function () {
                            e && e.wrapper &&
            ...
            a.editor.on("key", function (b) {
                var c = a.focused, d = a.widgetHoldingFocusedEditable, e; c ? e = c.fire("key", { keyCode: b.data.keyCode }) : d && (c = b.data.keyCode, b = d.focusedEditable, c == CKEDITOR.CTRL + 65 ? (c = b.getBogus(), d = d.editor.createRange(), d.selectNodeContents(b),
                    c && d.setEndAt(c, CKEDITOR.POSITION_BEFORE_START), d.select(), e = !1) : 8 == c || 46 == c ? (e = d.editor.getSelection().getRanges(), d = e[0], e = !(1 == e.length && d.collapsed && d.checkBoundaryOfElement(b, CKEDITOR[8 == c ? "START" : "END"]))) : e = void 0); return e
            }, null, null, 1)
        } function M(a) { function b(b) { a.focused && y(a.focused, "cut" == b.name) } var c = a.editor; c.on("contentDom", function () { var a = c.editable(); a.attachListener(a, "copy", b); a.attachListener(a, "cut", b) }) } function I(a) {
            var b = a.editor; b.on("selectionCheck", function () { a.fire("checkSelection") });
            a.on("checkSelection", a.checkSelection, a); b.on("selectionChange", function (c) { var d = (c = g.getNestedEditable(b.editable(), c.data.selection.getStartElement())) && a.getByElement(c), e = a.widgetHoldingFocusedEditable; e ? e === d && e.focusedEditable.equals(c) || (n(a, e, null), d && c && n(a, d, c)) : d && c && n(a, d, c) }); b.on("dataReady", function () { z(a).commit() }); b.on("blur", function () { var b; (b = a.focused) && t(a, b); (b = a.widgetHoldingFocusedEditable) && n(a, b, null) })
        } function G(a) {
            ...
            var b = a.editor, c, d; b.on("toHtml", function (b) {
                ...
                a = a.data; a.dataValue = a.dataValue.replace(U, T); a.range && (a = g.getNestedEditable(b.editable(), a.range.startContainer)) && (a = CKEDITOR.filter.instances[a.data("cke-filter")]) &&
                    b.setActiveFilter(a)
            ...
            if (a.draggable) {
                var b = a.editor,
                    c = a.wrapper.getLast(g.isDomDragHandlerContainer), d; c ? d = c.findOne("img") : (c = new CKEDITOR.dom.element("span", b.document), c.setAttributes({ "class": "cke_reset cke_widget_drag_handler_container", style: "background:rgba(220,220,220,0.5);background-image:url(" + b.plugins.widget.path + "images/handle.png)" }), d = new CKEDITOR.dom.element("img", b.document), d.setAttributes({
                        "class": "cke_reset cke_widget_drag_handler", "data-cke-widget-drag-handler": "1", src: CKEDITOR.tools.transparentImageData, width: 15, title: b.lang.widget.move,
                        height: 15, role: "presentation"
                    }), a.inline && d.setAttribute("draggable", "true"), c.append(d), a.wrapper.append(c)); a.wrapper.on("dragover", function (a) { a.data.preventDefault() }); a.wrapper.on("mouseenter", a.updateDragHandlerPosition, a); setTimeout(function () { a.on("data", a.updateDragHandlerPosition, a) }, 50); if (!a.inline && (d.on("mousedown", Y, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart", function (a) { a.data.preventDefault(!0) }); a.dragHandlerContainer = c
            }
        } function Y(a) {
            function b() {
                var b; for (q.reset(); b =
            ...
            } var c = this.repository.finder, d = this.repository.locator, e = this.repository.liner, f = this.editor, h = f.editable(), g = [], k = [], m, n; this.repository._.draggedWidget = this;
            ...
            var b, c, d = a.editables; a.editables = {}; if (a.editables) for (b in d) c = d[b], a.initEditable(b, "string" ==
                typeof c ? { selector: c } : c)
        } function aa(a) {
            if (a.mask) {
                var b = a.wrapper.findOne(".cke_widget_mask");

                b || (b = new CKEDITOR.dom.element("img", a.editor.document),
                    b.setAttributes({ src: CKEDITOR.tools.transparentImageData, "class": "cke_reset cke_widget_mask" }), a.wrapper.append(b));
                a.mask = b
            }
        } function ba(a) { if (a.parts) { var b = {}, c, d; for (d in a.parts) c = a.wrapper.findOne(a.parts[d]), b[d] = c; a.parts = b } } function N(a, b) {
            ca(a); ba(a); Z(a); aa(a); X(a); V(a); W(a); if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) a.wrapper.on("dragstart",
        ...
        } function ca(a) { (a.wrapper = a.element.getParent()).setAttribute("data-cke-widget-id", a.id) } function r(a) { a.element.data("cke-widget-data", encodeURIComponent(JSON.stringify(a.data))) }
        ...
        CKEDITOR.plugins.add("widget", {
            ...
            beforeInit: function (a) { a.widgets = new p(a) }, afterInit: function (a) { var b = a.widgets.registered, c, d, e; for (d in b) c = b[d], (e = c.button) && a.ui.addButton && a.ui.addButton(CKEDITOR.tools.capitalize(c.name, !0), { label: e, command: c.name, toolbar: "insert,10" }); S(a) }
        }); p.prototype = {
            MIN_SELECTION_CHECK_INTERVAL: 500, add: function (a, b) {
                b = CKEDITOR.tools.prototypedCopy(b); b.name = a; b._ = b._ || {}; this.editor.fire("widgetDefinition", b); b.template && (b.template = new CKEDITOR.template(b.template)); O(this.editor, b); P(this, b); return this.registered[a] =
                    b
                ...
                if (this.focused ===
                    a) { var b = a.editor, c = b.createRange(), d; (d = c.moveToClosestEditablePosition(a.wrapper, !0)) || (d = c.moveToClosestEditablePosition(a.wrapper, !1)); d && b.getSelection().selectRanges([c]) } a.wrapper.remove(); this.destroy(a, !0)
            }, destroy: function (a, b) { this.widgetHoldingFocusedEditable === a && n(this, a, null, b); a.destroy(b); delete this.instances[a.id]; this.fire("instanceDestroyed", a) }, destroyAll: function (a, b) {
            ...
            initOn: function (a, b, c) { b ? "string" == typeof b && (b = this.registered[b]) : b = this.registered[a.data("widget")]; if (!b) return null; var d = this.wrapElement(a, b.name); return d ? d.hasClass("cke_widget_new") ? (a = new g(this, this._.nextId++, a, b, c), a.isInited() ? this.instances[a.id] = a : null) : this.getByElement(a) : null }, initOnAll: function (a) { a = (a || this.editor.editable()).find(".cke_widget_new"); for (var b = [], c, d = a.count(); d--;)(c = this.initOn(a.getItem(d).getFirst(g.isDomWidgetElement))) && b.push(c); return b }, onWidget: function (a) {
                var b =
                    Array.prototype.slice.call(arguments); b.shift(); for (var c in this.instances) { var d = this.instances[c]; d.name == a && d.on.apply(d, b) } this.on("instanceCreated", function (d) { d = d.data; d.name == a && d.on.apply(d, b) })
                ...
                var c = null, d, e; if (a instanceof CKEDITOR.dom.element) {
                    ...
                    if ((c = a.getParent()) && c.type == CKEDITOR.NODE_ELEMENT && c.data("cke-widget-wrapper")) return c; a.hasAttribute("data-cke-widget-keep-attr") || a.data("cke-widget-keep-attr", a.data("widget") ? 1 : 0); a.data("widget", b); e = x(d, a.getName()); c = new CKEDITOR.dom.element(e ? "span" : "div"); c.setAttributes(v(e, b)); c.data("cke-display-name", d.pathName ? d.pathName : a.getName()); a.getParent(!0) && c.replace(a); a.appendTo(c)
                } else if (a instanceof CKEDITOR.htmlParser.element) {
                    b = b || a.attributes["data-widget"]; d = this.registered[b];
        ...
        CKEDITOR.event.implementOn(p.prototype); g.prototype = {
            addClass: function (a) { this.element.addClass(a); this.wrapper.addClass(g.WRAPPER_CLASS_PREFIX + a) }, applyStyle: function (a) { A(this, a, 1) }, checkStyleActive: function (a) { a = B(a); var b; if (!a) return !1; for (; b = a.pop();)if (!this.hasClass(b)) return !1; return !0 }, destroy: function (a) {
                this.fire("destroy"); if (this.editables) for (var b in this.editables) this.destroyEditable(b, a); a || ("0" == this.element.data("cke-widget-keep-attr") && this.element.removeAttribute("data-widget"),
                    this.element.removeAttributes(["data-cke-widget-data", "data-cke-widget-keep-attr"]), this.element.removeClass("cke_widget_element"), this.element.replace(this.wrapper)); this.wrapper = null
            }, destroyEditable: function (a, b) {
                var c = this.editables[a]; c.removeListener("focus", E); c.removeListener("blur", D); this.editor.focusManager.remove(c); b || (this.repository.destroyAll(!1, c), c.removeClass("cke_widget_editable"), c.removeClass("cke_widget_editable_focused"), c.removeAttributes(["contenteditable", "data-cke-widget-editable",
                    "data-cke-enter-mode"])); delete this.editables[a]
            }, edit: function () {
                var a = { dialog: this.dialog }, b = this; if (!1 === this.fire("edit", a) || !a.dialog) return !1; this.editor.openDialog(a.dialog, function (a) {
                    var d, e; !1 !== b.fire("dialog", a) && (d = a.on("show", function () { a.setupContent(b) }), e = a.on("ok", function () { var d, e = b.on("data", function (a) { d = 1; a.cancel() }, null, null, 0); b.editor.fire("saveSnapshot"); a.commitContent(b); e.removeListener(); d && (b.fire("data", b.data), b.editor.fire("saveSnapshot")) }), a.once("hide", function () {
                        d.removeListener();
                        e.removeListener()
                    }))
                }); return !0
                ...
                var c = this._findOneNotNested(b.selector); return c && c.is(CKEDITOR.dtd.$editable) ? (c = new q(this.editor, c, { filter: u.call(this.repository, this.name, a, b) }), this.editables[a] = c, c.setAttributes({ contenteditable: "true", "data-cke-widget-editable": a, "data-cke-enter-mode": c.enterMode }), c.filter &&
                ...
                return !(!this.wrapper ||
                    !this.inited)
            }, isReady: function () { return this.isInited() && this.ready }, focus: function () { var a = this.editor.getSelection(); if (a) { var b = this.editor.checkDirty(); a.fake(this.wrapper); !b && this.editor.resetDirty() } this.editor.focus() }, removeClass: function (a) { this.element.removeClass(a); this.wrapper.removeClass(g.WRAPPER_CLASS_PREFIX + a) }, removeStyle: function (a) { A(this, a, 0) }, setData: function (a, b) {
                var c = this.data, d = 0; if ("string" == typeof a) c[a] !== b && (c[a] = b, d = 1); else {
                    var e = a; for (a in e) c[a] !== e[a] && (d = 1, c[a] =
                        e[a])
                ...
                var a = this.editor, b = this.element.$, c = this._.dragHandlerOffset, b = { x: b.offsetLeft, y: b.offsetTop - 15 }; c && b.x == c.x && b.y == c.y || (c = a.checkDirty(),
                    a.fire("lockSnapshot"), this.dragHandlerContainer.setStyles({ top: b.y + "px", left: b.x + "px", display: "block" }), a.fire("unlockSnapshot"), !c && a.resetDirty(), this._.dragHandlerOffset = b)
            }
        ...
        g.isParserWidgetWrapper = function (a) { return a.type == CKEDITOR.NODE_ELEMENT && !!a.attributes["data-cke-widget-wrapper"] }; g.WRAPPER_CLASS_PREFIX = "cke_widget_wrapper_"; q.prototype = CKEDITOR.tools.extend(CKEDITOR.tools.prototypedCopy(CKEDITOR.dom.element.prototype), {
        ...
        }); var U = /^(?:<(?:div|span)(?: data-cke-temp="1")?(?: id="cke_copybin")?(?: data-cke-temp="1")?>)?(?:<(?:div|span)(?: style="[^"]+")?>)?<span [^>]*data-cke-copybin-start="1"[^>]*>.?<\/span>([\s\S]+)<span [^>]*data-cke-copybin-end="1"[^>]*>.?<\/span>(?:<\/(?:div|span)>)?(?:<\/(?:div|span)>)?$/i, da = { 37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1 }; (function () {
            function a() { }
            function b(a, b, c) { return c && this.checkElement(a) ? (a = c.widgets.getByElement(a, !0)) && a.checkStyleActive(this) : !1 } var c = {}; CKEDITOR.style.addCustomHandler({
                type: "widget", setup: function (a) { this.widget = a.widget; if (this.group = "string" == typeof a.group ? [a.group] : a.group) { a = this.widget; var b; c[a] || (c[a] = {}); for (var f = 0, h = this.group.length; f < h; f++)b = this.group[f], c[a][b] || (c[a][b] = []), c[a][b].push(this) } }, apply: function (a) {
                    ...
                    var b, f, h = !1; if (!(a instanceof CKEDITOR.editor)) return !1; f = a.elementPath(); if (this.checkApplicable(f, a)) for (var g = 0, k = this.group.length; g < k; g++) {
        ...
        })(); CKEDITOR.plugins.widget = g; g.repository = p; g.nestedEditable = q
    })(); (function () {

        CKEDITOR.plugins.add("chart", {
            requires: "widget,dialog", icons: "chart", lang: "en,es,pl", afterInit: function () { var a = this; "undefined" === typeof Chart && CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(a.path + "lib/chart.min.js"), function () { a.drawCharts() }) }, init: function (a) {
                var n = this, q = a.config.chart_height || 300, g = a.config.chart_colors || { fillColor: "rgba(151,187,205,0.5)", strokeColor: "rgba(151,187,205,0.8)", highlightFill: "rgba(151,187,205,0.75)", highlightStroke: "rgba(151,187,205,1)", data: "#B33131 #B66F2D #B6B330 #71B232 #33B22D #31B272 #2DB5B5 #3172B6 #3232B6 #6E31B2 #B434AF #B53071".split(" ") },
                    k = { Bar: a.config.chart_configBar || { animation: !1 }, Doughnut: a.config.chart_configDoughnut || { animateRotate: !1 }, Line: a.config.chart_configLine || { animation: !1 }, Pie: a.config.chart_configPie || { animateRotate: !1 }, PolarArea: a.config.chart_configPolarArea || { animateRotate: !1 } }, p = a.config.chart_maxItems || 8; a.addContentsCss(CKEDITOR.getUrl(n.path + "chart.css")); a.on("contentPreview", function (b) {
                        b.data.dataValue = b.data.dataValue.replace(/<\/head>/, '\x3cscript\x3evar chartjs_colors_json \x3d "' + JSON.stringify(g).replace(/\"/g,
                            '\\"') + '";\x3c/script\x3e\x3cscript\x3evar chartjs_config_json \x3d "' + JSON.stringify(k).replace(/\"/g, '\\"') + '";\x3c/script\x3e\x3cscript src\x3d"' + CKEDITOR.getUrl(n.path + "lib/chart.min.js") + '"\x3e\x3c/script\x3e\x3cscript src\x3d"' + CKEDITOR.getUrl(n.path + "widget2chart.js") + '"\x3e\x3c/script\x3e\x3c/head\x3e')
                    }); CKEDITOR.dialog.add("chart", function (b) {
                        for (var a = {
                            title: b.lang.chart.dialogTitle, minWidth: 200, minHeight: 100, onShow: function () {
                                var m = b.widgets.focused; if (m) for (var a = 0; a < p; a++)m.data.values[a] &&
                                    (this.setValueOf("data", "value" + a, m.data.values[a].value.toString()), this.setValueOf("data", "label" + a, m.data.values[a].label))
                            }, onOk: function () { for (var b = this.widget, a = [], d, c = 0; c < p; c++)(d = this.getValueOf("data", "value" + c)) && a.push({ value: parseFloat(this.getValueOf("data", "value" + c)), label: this.getValueOf("data", "label" + c) }); b.setData("values", a); b.setData("chart", this.getValueOf("data", "chart")); b.setData("height", this.getValueOf("data", "height")) }, contents: [{
                                id: "data", elements: [{
                                    type: "hbox", children: [{
                                        id: "chart",
                                        type: "select", label: b.lang.chart.chartType, labelLayout: "horizontal", labelStyle: "display:block;padding: 4px 6px;", items: [[b.lang.chart.bar, "bar"], [b.lang.chart.line, "line"], [b.lang.chart.pie, "pie"], [b.lang.chart.polar, "polar"], [b.lang.chart.doughnut, "doughnut"]], style: "margin-bottom:10px", setup: function (b) { this.setValue(b.data.chart) }
                                    }, {
                                        id: "height", type: "text", label: b.lang.chart.height, labelLayout: "horizontal", labelStyle: "display:block;padding: 4px 6px;", width: "50px", setup: function (b) { this.setValue(b.data.height) },
                                        validate: function () { var a = this.getValue(), a = !a || !!(CKEDITOR.dialog.validate.number(a) && 0 <= a); a || (alert(b.lang.common.validateNumberFailed), this.select()); return a }
                                    }]
                                }]
                            }]
                        }, d = 0; d < p; d++)a.contents[0].elements.push({
                            type: "hbox", children: [{
                                id: "value" + d, type: "text", labelLayout: "horizontal", label: b.lang.chart.value, labelStyle: "display:block;padding: 4px 6px;", width: "50px", validate: function () {
                                    var a = this.getValue(), a = !a || !!(CKEDITOR.dialog.validate.number(a) && 0 <= a); a || (alert(b.lang.common.validateNumberFailed),
                                        this.select()); return a
                                }
                            }, { id: "label" + d, type: "text", label: b.lang.chart.label, labelLayout: "horizontal", labelStyle: "display:block;padding: 4px 6px;", width: "200px" }]
                        }); return a
                    }); this.drawCharts = function () { for (var b in a.widgets.instances) "chart" == a.widgets.instances[b].name && a.widgets.instances[b].fire("data") }; a.widgets.add("chart", {
                        button: a.lang.chart.chart, dialog: "chart", template: '\x3cdiv class\x3d"chartjs" data-chart\x3d"bar" data-chart-height\x3d"' + q + '"\x3e\x3ccanvas height\x3d"' + q + '"\x3e\x3c/canvas\x3e\x3cdiv class\x3d"chartjs-legend"\x3e\x3c/div\x3e\x3c/div\x3e',
                        styleableElements: "div", pathName: "chart", init: function () { this.element.data("chart-value") && this.setData("values", JSON.parse(this.element.data("chart-value"))); this.setData("chart", this.element.data("chart")); this.setData("height", this.element.data("chart-height")); this.on("dialog", function (a) { a.data.widget = this }, this) }, data: function () {
                            if ("undefined" !== typeof Chart && this.data.values) {
                                var b = a.document.createElement("canvas", { attributes: { height: this.data.height } }); b.replace(this.element.getChild(0));
                                var f = this.element.getChild(1).$, b = b.$; if (b.getContext) {
                                    var d = this.data; setTimeout(function () {
                                        var a = d, e = a.values, h = a.chart, c; c = b.getContext("2d"); var l = new Chart(c); if ("bar" != h) for (c = 0; c < e.length; c++)e[c].color = g.data[c], e[c].highlight = g.data[c]; if ("bar" == h || "line" == h) {
                                            a = { datasets: [{ label: "", fillColor: g.fillColor, strokeColor: g.strokeColor, highlightFill: g.highlightFill, highlightStroke: g.highlightStroke, data: [] }], labels: [] }; for (c = 0; c < e.length; c++)e[c].value && (a.labels.push(e[c].label), a.datasets[0].data.push(e[c].value));
                                            f.innerHTML = ""
                                        } "bar" == h ? l.Bar(a, k.Bar) : "line" == h ? l.Line(a, k.Line) : f.innerHTML = "polar" == h ? l.PolarArea(e, k.PolarArea).generateLegend() : "pie" == h ? l.Pie(e, k.Pie).generateLegend() : l.Doughnut(e, k.Doughnut).generateLegend()
                                    }, 0)
                                }
                            }
                        }, allowedContent: "div(!chartjs)[data-*];", requiredContent: "div(chartjs)[data-chart-value,data-chart,data-chart-height]", upcast: function (a) {
                            if ("div" == a.name && a.hasClass("chartjs")) {
                                a.setHtml(""); var f = new CKEDITOR.htmlParser.element("canvas", { height: a.attributes["data-chart-height"] });
                                a.add(f); f = new CKEDITOR.htmlParser.element("div", { "class": "chartjs-legend" }); a.add(f); return a
                            }
                        }, downcast: function (b) { var f = []; if (this.data.values) { for (var d = 0; d < this.data.values.length; d++)f.push({ value: this.data.values[d].value, label: this.data.values[d].label }); return new CKEDITOR.htmlParser.element("div", { "class": b.attributes["class"], "data-chart": this.data.chart, "data-chart-height": this.data.height, "data-chart-value": a.getSelectedHtml ? JSON.stringify(f) : CKEDITOR.tools.htmlEncodeAttr(JSON.stringify(f)) }) } }
                    })
            }
        })
    })();
    ...
    CKEDITOR.plugins.add("ckeditor-gwf-plugin", {
        popup: null, fontLabel: null, init: function (a) {
            a.config.gwfplugin = a.config.gwfplugin || { font: {}, cancel: {}, ok: {}, message: {} }; a.config.gwfplugin.font = a.config.gwfplugin.font || {}; a.config.gwfplugin.cancel = a.config.gwfplugin.cancel || {}; a.config.gwfplugin.ok = a.config.gwfplugin.ok || {}; a.config.gwfplugin.message = a.config.gwfplugin.message || {}; this.fontLabel = a.config.gwfplugin.font.label || "GoogleWebFonts"; this.popup = this.popUp(a.config); var b = this; CKEDITOR.on("instanceReady",
                function (c) {
                    if (!c.editor.ui.instances.Font.gwfInjected) {
                        var a = c.editor.ui.instances.Font.onClick; c.editor.ui.instances.Font.onClick = function (d) {
                            d === b.fontLabel ? (b.popup.style.display = "block", b.popup.style.top = (window.innerHeight - 200) / 2 + "px", b.popup.style.left = (window.innerWidth - 150) / 2 + "px", b.popup.extraClickValue = function (a) {
                                for (var b = c.editor.editable().$.getElementsByTagName("link"), d = !1, i = 0; i < b.length; i++)if (b[i].getAttribute("href") === "https://fonts.googleapis.com/css?family=" + a) { d = !0; break } d ||
                                    (b = document.createElement("link"), b.setAttribute("type", "text/css"), b.setAttribute("rel", "stylesheet"), b.setAttribute("href", "https://fonts.googleapis.com/css?family=" + a), c.editor.editable().$.appendChild(b)); c.editor.applyStyle(new CKEDITOR.style({ element: "span", attributes: {}, styles: { "font-family": a } }))
                            }) : a.call(c.editor.ui.instances.Font, d)
                        }; c.editor.ui.instances.Font.gwfInjected = !0
                    }
                })
        }, popUp: function (a) {
            var b = document.createElement("link"); b.setAttribute("type", "text/css"); b.setAttribute("rel",
    ...
    Area.prototype = {
        ...
        function e(a, b, c) { this.editor = a; this.notification = null; this._message = new CKEDITOR.template(b); this._singularMessage = c ? new CKEDITOR.template(c) : null; this._tasks = []; this._doneTasks = this._doneWeights = this._totalWeights = 0 } function d(a) { this._weight = a || 1; this._doneWeight = 0; this._isCanceled = !1 }
        ...
        CKEDITOR.plugins.add("embedbase", { requires: "widget,notificationaggregator", onLoad: function () { CKEDITOR._.jsonpCallbacks = {} }, init: function () { CKEDITOR.dialog.add("embedBase", this.path + "dialogs/embedbase.js") } }); CKEDITOR.plugins.embedBase = {
            createWidgetBaseDefinition: function (e) {
                var c, d = e.lang.embedbase; return {
                    mask: !0, template: "\x3cdiv\x3e\x3c/div\x3e", pathName: d.pathName, _cache: {}, urlRegExp: /^((https?:)?\/\/|www\.)/i, init: function () {
                        this.on("sendRequest", function (a) { this._sendRequest(a.data) },
                            this, null, 999); this.on("dialog", function (a) { a.data.widget = this }, this); this.on("handleResponse", function (a) { if (!a.data.html) { var b = this._responseToHtml(a.data.url, a.data.response); null !== b ? a.data.html = b : (a.data.errorMessage = "unsupportedUrl", a.cancel()) } }, this, null, 999)
                    }, loadContent: function (a, b) {
                        function c(e) { f.response = e; d.editor.widgets.instances[d.id] ? d._handleResponse(f) && (d._cacheResponse(a, e), b.callback && b.callback()) : (CKEDITOR.warn("embedbase-widget-invalid"), f.task && f.task.done()) } b = b || {};
                        var d = this, e = this._getCachedResponse(a), f = { noNotifications: b.noNotifications, url: a, callback: c, errorCallback: function (a) { d._handleError(f, a); b.errorCallback && b.errorCallback(a) } }; if (e) setTimeout(function () { c(e) }); else return b.noNotifications || (f.task = this._createTask()), this.fire("sendRequest", f), f
                    }, isUrlValid: function (a) { return this.urlRegExp.test(a) && !1 !== this.fire("validateUrl", a) }, getErrorMessage: function (a, b, c) {
                        (c = e.lang.embedbase[a + (c || "")]) || (c = a); return (new CKEDITOR.template(c)).output({
                            url: b ||
                            ""
                        })
                        ...
                        a.task && (a.task.cancel(), a.noNotifications ||
                        ...
                        if (!c || c.isFinished()) c =
                            new CKEDITOR.plugins.notificationAggregator(e, d.fetchingMany, d.fetchingOne), c.on("finished", function () { c.notification.hide() }); return c.createTask()
                    }, _cacheResponse: function (a, b) { this._cache[a] = b }, _getCachedResponse: function (a) { return this._cache[a] }
                }
            }, _jsonp: l
        }
    })();
    (function () {
        ...
        CKEDITOR.plugins.add("embed", {
            requires: "embedbase", init: function (b) {
                ...
                CKEDITOR.tools.extend(c, {
                    ...
                    providerUrl:
                    new CKEDITOR.template(b.config.embed_provider || "//ckeditor.iframe.ly/api/oembed?url\x3d{url}\x26callback\x3d{callback}"),
    ...
    (function () {
        ...
        function h(a, c, d) {
            if (-1 !== d.indexOf(";")) {
                ...
                for (var b = 0; b < d.length; b++)
                    if (h(a, c, d[b])) return !0; return !1
        ...
        CKEDITOR.on("dialogDefinition", function (a) {
            if (a.editor.plugins.filebrowser) for (var c = a.data.definition, d, b = 0; b < c.contents.length; ++b)
    ...
    (function () {
        ...
        } function t(a, c, h) { var e = c.pop(); if (e) { if (h) return t(a, c, e.equals(h) ? null : h); h = e.clone(); a.insertNode(h); a.moveToPosition(h, CKEDITOR.POSITION_AFTER_START); t(a, c) } }
    ...
    //HACK: Comic Sans MS/Comic Sans MS, cursive removed.
    ...
    //Font sizes 28-72px removed
    CKEDITOR.config.font_defaultLabel = ""; CKEDITOR.config.font_style = { element: "span", styles: { "font-family": "#(family)" }, overrides: [{ element: "font", attributes: { face: null } }] }; CKEDITOR.config.fontSize_sizes = "10/0.714em !important;11/0.786em !important;12/0.857em !important;14/1.000em !important;16/1.143em !important;18/1.286em !important;20/1.429em !important;22/1.571em !important;24/1.714em !important;26/1.857em !important"; CKEDITOR.config.fontSize_defaultLabel = ""; CKEDITOR.config.fontSize_style = { element: "span", styles: { "font-size": "#(size)" }, overrides: [{ element: "font", attributes: { size: null } }] };
        ...
        requires: "richcombo", init: function (a) {
            if (!a.blockless) {
                for (var f = a.config, c = a.lang.format, l = f.format_tags.split(";"), d = {}, m = 0, n = [], g = 0; g < l.length; g++) {
                    ...
                    onOpen: function () {
                        this.showAll(); for (var b in d) a.activeFilter.check(d[b]) || this.hideItem(b)
                    },
                    refresh: function () {
    ...
    CKEDITOR.plugins.add("glyphicons", {
        requires: "widget,colordialog", icons: "glyphicons", init: function (b) {
            b.widgets.add("Glyphicons", {
                button: "Glyphicons", template: '\x3cspan class\x3d"" style\x3d""\x3e\x3c/span\x3e', dialog: "glyphiconsDialog", allowedContent: "span(*){*}", upcast: function (a) { return "span" == a.name && a.hasClass("glyphicon") }, init: function () { this.setData("class", this.element.getAttribute("class")); this.setData("color", this.element.getStyle("color")); this.setData("size", this.element.getStyle("font-size")) },
                data: function () { var a = ""; this.element.setAttribute("class", this.data["class"]); a += "" != this.data.color ? "color:" + this.data.color + ";" : ""; a += "" != this.data.size ? "font-size:" + parseInt(this.data.size) + "px;" : ""; "" != a ? this.element.setAttribute("style", a) : "" }
            }); b.ui.addButton("Glyphicons", { command: "glyphicons", icon: this.path + "icons/glyphicons.png" }); CKEDITOR.dialog.add("glyphiconsDialog", this.path + "dialogs/glyphicons.js"); CKEDITOR.document.appendStyleSheet(CKEDITOR.plugins.getPath("glyphicons") + "css/style.css")
        }
    });

    CKEDITOR.plugins.add("html5audio", {
        requires: "widget", lang: "de,en,eu,es,fr,ru,uk,uz", icons: "html5audio", init: function (b) {
            b.widgets.add("html5audio", {
                button: b.lang.html5audio.button, template: '\x3cdiv class\x3d"ckeditor-html5-audio"\x3e\x3c/div\x3e', editables: {}, allowedContent: "div(!ckeditor-html5-audio){text-align,float,margin-left,margin-right}; audio[src,controls,autoplay];", requiredContent: "div(ckeditor-html5-audio); audio[src,controls];", upcast: function (a) { return "div" === a.name && a.hasClass("ckeditor-html5-audio") },
                dialog: "html5audio", init: function () { var a = "", b = "", c = this.element.getStyle("text-align"); this.element.getChild(0) && (a = this.element.getChild(0).getAttribute("src"), b = this.element.getChild(0).getAttribute("autoplay")); a && (this.setData("src", a), c ? this.setData("align", c) : this.setData("align", "none"), b && this.setData("autoplay", "yes")) }, data: function () {
                    if (this.data.src) {
                        if (!this.element.getChild(0)) { var a = new CKEDITOR.dom.element("audio"); a.setAttribute("controls", "controls"); this.element.append(a) } this.element.getChild(0).setAttribute("src",
                            this.data.src)
                    } this.element.removeStyle("float"); this.element.removeStyle("margin-left"); this.element.removeStyle("margin-right"); "none" === this.data.align ? this.element.removeStyle("text-align") : this.element.setStyle("text-align", this.data.align); "left" === this.data.align ? (this.element.setStyle("float", this.data.align), this.element.setStyle("margin-right", "10px")) : "right" === this.data.align && (this.element.setStyle("float", this.data.align), this.element.setStyle("margin-left", "10px")); this.element.getChild(0) &&
                        ("yes" === this.data.autoplay ? this.element.getChild(0).setAttribute("autoplay", "autoplay") : this.element.getChild(0).removeAttribute("autoplay"))
                }
            }); b.contextMenu && (b.addMenuGroup("html5audioGroup"), b.addMenuItem("html5audioPropertiesItem", { label: b.lang.html5audio.audioProperties, icon: "html5audio", command: "html5audio", group: "html5audioGroup" }), b.contextMenu.addListener(function (a) { if (a && a.getChild(0) && a.getChild(0).hasClass && a.getChild(0).hasClass("ckeditor-html5-audio")) return { html5audioPropertiesItem: CKEDITOR.TRISTATE_OFF } }));
            CKEDITOR.dialog.add("html5audio", this.path + "dialogs/html5audio.js")
        }
    });

    CKEDITOR.plugins.add("htmlwriter", { init: function (b) { var a = new CKEDITOR.htmlWriter; a.forceSimpleAmpersand = b.config.forceSimpleAmpersand; a.indentationChars = b.config.dataIndentationChars || "\t"; b.dataProcessor.writer = a } });
    CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
        ...
        function e(b, a) { a || (a = b.getSelection().getSelectedElement()); if (a && a.is("img") && !a.data("cke-realelement") && !a.isReadOnly()) return a } function f(b) { var a = b.getStyle("float"); if ("inherit" == a || "none" == a) a = 0; a || (a = b.getAttribute("align")); return a }
        ...
        } function t(c) { return c.type == CKEDITOR.NODE_ELEMENT && c.is("li") } function x(c) { return y(c) && z(c) } var y = CKEDITOR.dom.walker.whitespaces(!0), z = CKEDITOR.dom.walker.bookmark(!1, !0), u = CKEDITOR.TRISTATE_DISABLED, v = CKEDITOR.TRISTATE_OFF;
    ...
    CKEDITOR.config.magicline_keystrokeNext = CKEDITOR.CTRL + CKEDITOR.SHIFT + 52; (function () {
        ...
        CKEDITOR.plugins.add("mathjax", {
            requires: "widget,dialog", icons: "mathjax", init: function (b) {
                var c = b.config.mathJaxClass || "math-tex"; b.config.mathJaxLib || CKEDITOR.error("mathjax-no-config"); b.widgets.add("mathjax", {
                    inline: !0, dialog: "mathjax", button: b.lang.mathjax.button, mask: !0, allowedContent: "span(!" + c + ")", styleToAllowedContentRules: function (a) { a = a.getClassesArray(); if (!a) return null; a.push("!" + c); return "span(" + a.join(",") + ")" }, pathName: b.lang.mathjax.pathName, template: '\x3cspan class\x3d"' +
                    c + '" style\x3d"display:inline-block" data-cke-survive\x3d1\x3e\x3c/span\x3e', parts: { span: "span" }, defaults: { math: "\\(x \x3d {-b \\pm \\sqrt{b^2-4ac} \\over 2a}\\)" }, init: function () {
                        var a = this.parts.span.getChild(0); a && a.type == CKEDITOR.NODE_ELEMENT && a.is("iframe") || (a = new CKEDITOR.dom.element("iframe"), a.setAttributes({ style: "border:0;width:0;height:0", scrolling: "no", frameborder: 0, allowTransparency: !0, src: CKEDITOR.plugins.mathjax.fixSrc }), this.parts.span.append(a)); this.once("ready", function () {
                            CKEDITOR.env.ie &&
                                a.setAttribute("src", CKEDITOR.plugins.mathjax.fixSrc); this.frameWrapper = new CKEDITOR.plugins.mathjax.frameWrapper(a, b); this.frameWrapper.setValue(this.data.math)
                        })
                        ...
                        if ("span" == a.name && a.hasClass(c) && !(1 < a.children.length || a.children[0].type != CKEDITOR.NODE_TEXT)) {
                            b.math = CKEDITOR.tools.htmlDecode(a.children[0].value); var d = a.attributes; d.style = d.style ? d.style + ";display:inline-block" : "display:inline-block";
                            d["data-cke-survive"] = 1; a.children[0].remove(); return a
                        }
                ...
                }); CKEDITOR.dialog.add("mathjax", this.path + "dialogs/mathjax.js"); b.on("contentPreview", function (a) {
                    a.data.dataValue = a.data.dataValue.replace(/<\/head>/, '\x3cscript src\x3d"' + CKEDITOR.getUrl(b.config.mathJaxLib) +
    ...
    CKEDITOR.plugins.add("pastefromexcel", {
        requires: "clipboard", init: function (g) {
            if (!CKEDITOR.env.ie) {
                var h = function (b) {
                    b = this._.normalizeType(b); var a = this._.data[b]; if (void 0 === a || null === a || "" === a) try { a = this.$.getData(b) } catch (g) { } if (void 0 === a || null === a || "" === a) a = ""; if ("text/html" == b) {
                        a = a.replace(this._.metaRegExp, ""); if (-1 != a.search(/<meta.*?Microsoft Excel\s[\d].*?>/) || -1 != a.search(/<meta.*?Microsoft Word\s[\d].*?>/)) {
                            var c = a, c = c.substring(c.indexOf("\x3chtml "), c.length), c = c.substring(0, c.lastIndexOf("\x3c/html\x3e") +
                                7), a = document.createElement("iframe"); a.style.display = "none"; document.body.appendChild(a); b = a.contentDocument || a.contentWindow.document; b.open(); b.write(c); b.close(); for (var d, f = b.styleSheets[b.styleSheets.length - 1].cssRules, e = 0; e < f.length; e++)if ("" !== f[e].selectorText) for (c = b.body.querySelectorAll(f[e].selectorText), d = 0; d < c.length; d++)c[d].style.cssText += f[e].style.cssText; b = b.firstChild.outerHTML; a.parentNode.removeChild(a); a = b
                        } (b = this._.bodyRegExp.exec(a)) && b.length && (a = b[1], a = a.replace(this._.fragmentRegExp,
                            ""))
                    } else "Text" == b && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == a.substring(0, 7) && (a = ""); return a
                }; g.on("instanceReady", function () { CKEDITOR.plugins.clipboard.dataTransfer.prototype.getData = h })
            }
        }
    }); (function () {
        function l(a, b, f) { var d = CKEDITOR.cleanWord; d ? f() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || b + "filter/default.js"), CKEDITOR.scriptLoader.load(a, f, null, !0)); return !d } function g(a) { a.data.type = "html" }
        ...
        var c = { canUndo: !1, async: !0, exec: function (a) { a.getClipboardData({ title: a.lang.pastetext.title }, function (b) { b && a.fire("paste", { type: "text", dataValue: b.dataValue, method: "paste", dataTransfer: CKEDITOR.plugins.clipboard.initPasteDataTransfer() }); a.fire("afterCommandExec", { name: "pastetext", command: c, returnValue: !!b }) }) } };
    ...
    CKEDITOR.on("scaytReady", function () {
        ...
        var f = { preserveState: !0, editorFocus: !1, readOnly: 1, exec: function (a) { this.toggleState(); this.refresh(a) }, refresh: function (a) { if (a.document) { var b = this.state == CKEDITOR.TRISTATE_ON ? "attachClass" : "removeClass"; a.editable()[b]("cke_show_borders") } } };
    ...
    CKEDITOR.plugins.add("symbol", {
        availableLangs: { en: 1 }, lang: "en", requires: "dialog", icons: "symbol", init: function (a) {
            var c = this; CKEDITOR.dialog.add("symbol", this.path + "dialogs/symbol.js"); a.addCommand("symbol", {
                exec: function () {
                    if (a.config.removeSymbolRanges && 0 < a.config.removeSymbolRanges.length) for (var d = a.config.removeSymbolRanges.length - 1; 0 <= d; d--) { var e = a.config.removeSymbolRanges[d]; e < a.config.symbolRanges.length && a.config.symbolRanges.splice(e, 1) } var b = a.langCode, b = c.availableLangs[b] ? b : c.availableLangs[b.replace(/-.*/,
                        "")] ? b.replace(/-.*/, "") : "en"; CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(c.path + "dialogs/lang/" + b + ".js"), function () { CKEDITOR.tools.extend(a.lang.symbol, c.langEntries[b]); a.openDialog("symbol") })
                }, modes: { wysiwyg: 1 }, canUndo: !1
            }); a.ui.addButton && a.ui.addButton("Symbol", { label: "Insert symbol", command: "symbol", toolbar: "insert" })
        }
    });
    CKEDITOR.config.symbolRanges = [["Arrows", "2190-21FF"],
    ...
    ["Supplemental Mathematical Operators", "2A00-2AFF"]]; (function () {
            function k(c) {
                return {
    ...
    CKEDITOR.dom.element.prototype.focusPrevious = function (k, h) { for (var g = void 0 === h ? this.getTabIndex() : h, f, c, d, e = 0, b, a = this.getDocument().getBody().getLast(); a = a.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT);) { if (!f) if (!c && a.equals(this)) { if (c = !0, k) { if (!(a = a.getPreviousSourceNode(!0, CKEDITOR.NODE_ELEMENT))) break; f = 1 } } else c && !this.contains(a) && (f = 1); if (a.isVisible() && !(0 > (b = a.getTabIndex()))) if (0 >= g) { if (f && 0 === b) { d = a; break } b > e && (d = a, e = b) } else { if (f && b == g) { d = a; break } b < g && (!d || b > e) && (d = a, e = b) } } d && d.focus() }; (function () {
    ...
    *You need to pass the updated image urls to config variable through javascript or php
    ...
    tabbedloadjscssfile(CKEDITOR.basePath + CKEDITOR.plugins.basePath + 'tabbedimagebrowser/plugin.css', "css");
    ...
    var GenerateTabbedHTMLfromArray = function (largeimages, thumbimages, dsbrowblocklabel) {
        ...
        if (check_tabbedimages) {
            ...
            for (var i = 0; i < largeimages.length; i++) {
                ...
                tabbedimages_html += '<div class="dsimageblock" style="background-image:url(' + thumbimages[i] + ');"></div>';
                ...
                tabbedimages_html += '<div class="buttons"><span class="image-edit" data-image="' + largeimages[i] + '">Edit</span><span class="image-delete" data-image="' + largeimages[i] + '">Delete</span></div>';
    ...
    var ReplaceDSbrowserHTML = function () {
        ...
        if (document.getElementById('dsbrowserfullcontainer') != null)
            document.getElementById('dsbrowserfullcontainer').innerHTML = tabbedimages_html;
    };

    $(document).on("updateGallery", function () {
        ReplaceDSbrowserHTML();
    });
    ...
    */
            ...
            init: function (editor) {
                ...
                CKEDITOR.on('dialogDefinition', function (ev) {
                    ...
                    if (dialogName === 'image') {
                        ...
                        if (dialogDefinition.contents.length < 5)
    ...
    CKEDITOR.config.plugins = 'justify,format,colorbutton,dialogui,dialog,a11yhelp,clipboard,autolink,undo,autoembed,basicstyles,lineutils,widgetselection,widget,panel,floatpanel,menu,contextmenu,elementspath,button,toolbar,notification,notificationaggregator,embedbase,embed,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,font,colordialog,html5audio,htmlwriter,image,indent,indentlist,fakeobjects,link,list,magicline,mathjax,chart,pastebase64,pastefromexcel,pastefromword,pastetext,removeformat,resize,menubutton,scayt,showborders,sourcearea,stylescombo,symbol,tab,wsc,wysiwygarea,tabbedimagebrowser';
    //glyphicons, templates ckeditor-gwf-plugin 
    CKEDITOR.config.skin = 'moono-lisa'; (function () {
        var setIcons = function (icons, strip) {
            var path = CKEDITOR.getUrl('plugins/' + strip); icons = icons.split(',');
            for (var i = 0; i < icons.length; i++)CKEDITOR.skin.icons[icons[i]] = {
                path: path, offset: -icons[++i], bgsize: icons[++i]
            };
        };
        if (CKEDITOR.env.hidpi)
            setIcons('copy-rtl,0,,copy,24,,cut-rtl,48,,cut,72,,paste-rtl,96,,paste,120,,redo-rtl,144,,redo,168,,undo-rtl,192,,undo,216,,bold,240,,italic,264,,strike,288,,subscript,312,,superscript,336,,underline,360,,chart,768,auto,embed,408,,glyphicons,864,auto,html5audio,912,auto,image,480,,indent-rtl,504,,indent,528,,outdent-rtl,552,,outdent,576,,anchor-rtl,600,,anchor,624,,link,648,,unlink,672,,bulletedlist-rtl,696,,bulletedlist,720,,numberedlist-rtl,744,,numberedlist,768,,mathjax,792,,pastefromword-rtl,816,,pastefromword,840,,pastetext-rtl,864,,pastetext,888,,removeformat,912,,scayt,936,,source-rtl,960,,source,984,,symbol,2016,auto,templates-rtl,1032,,templates,1056,,spellchecker,1080,', 'icons_hidpi.png'); else setIcons('copy-rtl,0,auto,copy,24,auto,cut-rtl,48,auto,cut,72,auto,paste-rtl,96,auto,paste,120,auto,redo-rtl,144,auto,redo,168,auto,undo-rtl,192,auto,undo,216,auto,bold,240,auto,italic,264,auto,strike,288,auto,subscript,312,auto,superscript,336,auto,underline,360,auto,chart,384,auto,embed,408,auto,glyphicons,432,auto,html5audio,456,auto,image,480,auto,indent-rtl,504,auto,indent,528,auto,outdent-rtl,552,auto,outdent,576,auto,anchor-rtl,600,auto,anchor,624,auto,link,648,auto,unlink,672,auto,bulletedlist-rtl,696,auto,bulletedlist,720,auto,numberedlist-rtl,744,auto,numberedlist,768,auto,mathjax,792,auto,pastefromword-rtl,816,auto,pastefromword,840,auto,pastetext-rtl,864,auto,pastetext,888,auto,removeformat,912,auto,scayt,936,auto,source-rtl,960,auto,source,984,auto,symbol,1008,auto,templates-rtl,1032,auto,templates,1056,auto,spellchecker,1080,auto', 'icons.png');
    })();
...
(function () {
    var l = this, d = l.Chart, c = function (a) { this.canvas = a.canvas; this.ctx = a; var g = function (a, g) { return a["offset" + g] ? a["offset" + g] : document.defaultView.getComputedStyle(a).getPropertyValue(g) }; this.width = g(a.canvas, "Width") || a.canvas.width; this.height = g(a.canvas, "Height") || a.canvas.height; return this.aspectRatio = this.width / this.height, b.retinaScale(this), this }; c.defaults = {
        global: {
            animation: !0, animationSteps: 60, animationEasing: "easeOutQuart", showScale: !0, scaleOverride: !1, scaleSteps: null, scaleStepWidth: null,
    ...
    }; c.types = {}; var b = c.helpers = {}, e = b.each = function (a, g, f) {
        var b = Array.prototype.slice.call(arguments, 3); if (a) if (a.length === +a.length) {
            var e;
            for (e = 0; e < a.length; e++)g.apply(f, [a[e], e].concat(b))
        } else for (e in a) g.apply(f, [a[e], e].concat(b))
    }, h = b.clone = function (a) { var g = {}; return e(a, function (f, b) { a.hasOwnProperty(b) && (g[b] = f) }), g }, k = b.extend = function (a) { return e(Array.prototype.slice.call(arguments, 1), function (g) { e(g, function (f, b) { g.hasOwnProperty(b) && (a[b] = f) }) }), a }, u = b.merge = function (a, g) { var f = Array.prototype.slice.call(arguments, 0); return f.unshift({}), k.apply(null, f) }, G = b.indexOf = function (a, g) {
        if (Array.prototype.indexOf) return a.indexOf(g);
        for (var f = 0; f < a.length; f++)if (a[f] === g) return f; return -1
    }, n = (b.where = function (a, g) { var f = []; return b.each(a, function (a) { g(a) && f.push(a) }), f }, b.findNextWhere = function (a, g, f) { f || (f = -1); for (f += 1; f < a.length; f++) { var b = a[f]; if (g(b)) return b } }, b.findPreviousWhere = function (a, g, f) { f || (f = a.length); for (--f; 0 <= f; f--) { var b = a[f]; if (g(b)) return b } }, b.inherits = function (a) {
        var g = this, f = a && a.hasOwnProperty("constructor") ? a.constructor : function () { return g.apply(this, arguments) }, b = function () { this.constructor = f }; return b.prototype =
            g.prototype, f.prototype = new b, f.extend = n, a && k(f.prototype, a), f.__super__ = g.prototype, f
    }), m = b.noop = function () { }, H = b.uid = function () { var a = 0; return function () { return "chart-" + a++ } }(), I = b.warn = function (a) { window.console && "function" == typeof window.console.warn && console.warn(a) }, J = b.amd = "function" == typeof define && define.amd, q = b.isNumber = function (a) { return !isNaN(parseFloat(a)) && isFinite(a) }, x = b.max = function (a) { return Math.max.apply(Math, a) }, v = b.min = function (a) { return Math.min.apply(Math, a) }, C = (b.cap = function (a,
        g, f) { if (q(g)) { if (a > g) return g } else if (q(f) && f > a) return f; return a }, b.getDecimalPlaces = function (a) { if (0 !== a % 1 && q(a)) { a = a.toString(); if (0 > a.indexOf("e-")) return a.split(".")[1].length; if (0 > a.indexOf(".")) return parseInt(a.split("e-")[1]); a = a.split(".")[1].split("e-"); return a[0].length + parseInt(a[1]) } return 0 }), z = b.radians = function (a) { return Math.PI / 180 * a }, D = (b.getAngleFromPoint = function (a, g) {
            var f = g.x - a.x, b = g.y - a.y, e = Math.sqrt(f * f + b * b), c = 2 * Math.PI + Math.atan2(b, f); return 0 > f && 0 > b && (c += 2 * Math.PI), {
                angle: c,
                distance: e
            }
        }, b.aliasPixel = function (a) { return 0 === a % 2 ? 0 : .5 }), K = (b.splineCurve = function (a, g, f, b) { var e = Math.sqrt(Math.pow(g.x - a.x, 2) + Math.pow(g.y - a.y, 2)), c = Math.sqrt(Math.pow(f.x - g.x, 2) + Math.pow(f.y - g.y, 2)), d = b * e / (e + c); b = b * c / (e + c); return { inner: { x: g.x - d * (f.x - a.x), y: g.y - d * (f.y - a.y) }, outer: { x: g.x + b * (f.x - a.x), y: g.y + b * (f.y - a.y) } } }, b.calculateOrderOfMagnitude = function (a) { return Math.floor(Math.log(a) / Math.LN10) }), r = (b.calculateScaleRange = function (a, g, f, b, c) {
            g = Math.floor(g / (1.5 * f)); f = 2 >= g; var d = []; e(a, function (a) {
                null ==
                a || d.push(a)
            }); var h = v(d), k = x(d); k === h && (k += .5, .5 <= h && !b ? h -= .5 : k += .5); a = Math.abs(k - h); a = K(a); k = Math.ceil(k / (1 * Math.pow(10, a))) * Math.pow(10, a); b = b ? 0 : Math.floor(h / (1 * Math.pow(10, a))) * Math.pow(10, a); for (var h = k - b, k = Math.pow(10, a), p = Math.round(h / k); (p > g || g > 2 * p) && !f;)if (p > g) k *= 2, p = Math.round(h / k), 0 !== p % 1 && (f = !0); else { if (c && 0 <= a && 0 !== k / 2 % 1) break; k /= 2; p = Math.round(h / k) } return f && (p = 2, k = h / p), { steps: p, stepValue: k, min: b, max: b + p * k }
        }, b.template = function (a, g) {
            if (a instanceof Function) return a(g); var f = {}, f = /\W/.test(a) ?
                new Function("obj", "var p\x3d[],print\x3dfunction(){p.push.apply(p,arguments);};with(obj){p.push('" + a.replace(/[\r\t\n]/g, " ").split("\x3c%").join("\t").replace(/((^|%>)[^\t]*)'/g, "$1\r").replace(/\t=(.*?)%>/g, "',$1,'").split("\t").join("');").split("%\x3e").join("p.push('").split("\r").join("\\'") + "');}return p.join('');") : f[a] = f[a]; return g ? f(g) : f
        }), w = (b.generateLabels = function (a, g, f, b) { var c = Array(g); return a && e(c, function (g, e) { c[e] = r(a, { value: f + b * (e + 1) }) }), c }, b.easingEffects = {
            linear: function (a) { return a },
            easeInQuad: function (a) { return a * a }, easeOutQuad: function (a) { return -1 * a * (a - 2) }, easeInOutQuad: function (a) { return 1 > (a /= .5) ? .5 * a * a : -.5 * (--a * (a - 2) - 1) }, easeInCubic: function (a) { return a * a * a }, easeOutCubic: function (a) { return 1 * ((a = a / 1 - 1) * a * a + 1) }, easeInOutCubic: function (a) { return 1 > (a /= .5) ? .5 * a * a * a : .5 * ((a -= 2) * a * a + 2) }, easeInQuart: function (a) { return a * a * a * a }, easeOutQuart: function (a) { return -1 * ((a = a / 1 - 1) * a * a * a - 1) }, easeInOutQuart: function (a) { return 1 > (a /= .5) ? .5 * a * a * a * a : -.5 * ((a -= 2) * a * a * a - 2) }, easeInQuint: function (a) {
                return 1 *
                    (a /= 1) * a * a * a * a
            }, easeOutQuint: function (a) { return 1 * ((a = a / 1 - 1) * a * a * a * a + 1) }, easeInOutQuint: function (a) { return 1 > (a /= .5) ? .5 * a * a * a * a * a : .5 * ((a -= 2) * a * a * a * a + 2) }, easeInSine: function (a) { return -1 * Math.cos(a / 1 * (Math.PI / 2)) + 1 }, easeOutSine: function (a) { return 1 * Math.sin(a / 1 * (Math.PI / 2)) }, easeInOutSine: function (a) { return -.5 * (Math.cos(Math.PI * a / 1) - 1) }, easeInExpo: function (a) { return 0 === a ? 1 : 1 * Math.pow(2, 10 * (a / 1 - 1)) }, easeOutExpo: function (a) { return 1 === a ? 1 : 1 * (-Math.pow(2, -10 * a / 1) + 1) }, easeInOutExpo: function (a) {
                return 0 ===
                    a ? 0 : 1 === a ? 1 : 1 > (a /= .5) ? .5 * Math.pow(2, 10 * (a - 1)) : .5 * (-Math.pow(2, -10 * --a) + 2)
            }, easeInCirc: function (a) { return 1 <= a ? a : -1 * (Math.sqrt(1 - (a /= 1) * a) - 1) }, easeOutCirc: function (a) { return 1 * Math.sqrt(1 - (a = a / 1 - 1) * a) }, easeInOutCirc: function (a) { return 1 > (a /= .5) ? -.5 * (Math.sqrt(1 - a * a) - 1) : .5 * (Math.sqrt(1 - (a -= 2) * a) + 1) }, easeInElastic: function (a) { var g = 1.70158, f = 0, b = 1; return 0 === a ? 0 : 1 == (a /= 1) ? 1 : (f || (f = .3), b < Math.abs(1) ? (b = 1, g = f / 4) : g = f / (2 * Math.PI) * Math.asin(1 / b), -(b * Math.pow(2, 10 * --a) * Math.sin(2 * (1 * a - g) * Math.PI / f))) }, easeOutElastic: function (a) {
                var g =
                    1.70158, b = 0, e = 1; return 0 === a ? 0 : 1 == (a /= 1) ? 1 : (b || (b = .3), e < Math.abs(1) ? (e = 1, g = b / 4) : g = b / (2 * Math.PI) * Math.asin(1 / e), e * Math.pow(2, -10 * a) * Math.sin(2 * (1 * a - g) * Math.PI / b) + 1)
            }, easeInOutElastic: function (a) { var g = 1.70158, b = 0, e = 1; return 0 === a ? 0 : 2 == (a /= .5) ? 1 : (b || (b = .3 * 1.5), e < Math.abs(1) ? (e = 1, g = b / 4) : g = b / (2 * Math.PI) * Math.asin(1 / e), 1 > a ? -.5 * e * Math.pow(2, 10 * --a) * Math.sin(2 * (1 * a - g) * Math.PI / b) : e * Math.pow(2, -10 * --a) * Math.sin(2 * (1 * a - g) * Math.PI / b) * .5 + 1) }, easeInBack: function (a) { return 1 * (a /= 1) * a * (2.70158 * a - 1.70158) }, easeOutBack: function (a) {
                return 1 *
                    ((a = a / 1 - 1) * a * (2.70158 * a + 1.70158) + 1)
            }, easeInOutBack: function (a) { var g = 1.70158; return 1 > (a /= .5) ? .5 * a * a * (((g *= 1.525) + 1) * a - g) : .5 * ((a -= 2) * a * (((g *= 1.525) + 1) * a + g) + 2) }, easeInBounce: function (a) { return 1 - w.easeOutBounce(1 - a) }, easeOutBounce: function (a) { return (a /= 1) < 1 / 2.75 ? 7.5625 * a * a : 2 / 2.75 > a ? 1 * (7.5625 * (a -= 1.5 / 2.75) * a + .75) : 2.5 / 2.75 > a ? 1 * (7.5625 * (a -= 2.25 / 2.75) * a + .9375) : 1 * (7.5625 * (a -= 2.625 / 2.75) * a + .984375) }, easeInOutBounce: function (a) { return .5 > a ? .5 * w.easeInBounce(2 * a) : .5 * w.easeOutBounce(2 * a - 1) + .5 }
        }), E = b.requestAnimFrame =
            function () { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) { return window.setTimeout(a, 1E3 / 60) } }(), L = (b.cancelAnimFrame = function () { return window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || window.msCancelAnimationFrame || function (a) { return window.clearTimeout(a, 1E3 / 60) } }(), b.animationLoop = function (a,
                g, b, e, c, d) { var h = 0, k = w[b] || w.linear, p = function () { h++; var b = h / g, f = k(b); a.call(d, f, b, h); e.call(d, f, b); g > h ? d.animationFrame = E(p) : c.apply(d) }; E(p) }, b.getRelativePosition = function (a) { var b, f, e = a.originalEvent || a; a = (a.currentTarget || a.srcElement).getBoundingClientRect(); return e.touches ? (b = e.touches[0].clientX - a.left, f = e.touches[0].clientY - a.top) : (b = e.clientX - a.left, f = e.clientY - a.top), { x: b, y: f } }, b.addEvent = function (a, b, f) {
                    a.addEventListener ? a.addEventListener(b, f) : a.attachEvent ? a.attachEvent("on" + b, f) :
                        a["on" + b] = f
                }), M = b.removeEvent = function (a, b, f) { a.removeEventListener ? a.removeEventListener(b, f, !1) : a.detachEvent ? a.detachEvent("on" + b, f) : a["on" + b] = m }, N = (b.bindEvents = function (a, b, f) { a.events || (a.events = {}); e(b, function (b) { a.events[b] = function () { f.apply(a, arguments) }; L(a.chart.canvas, b, a.events[b]) }) }, b.unbindEvents = function (a, b) { e(b, function (b, g) { M(a.chart.canvas, g, b) }) }), O = b.getMaximumWidth = function (a) {
                    a = a.parentNode; var b = parseInt(y(a, "padding-left")) + parseInt(y(a, "padding-right")); return a ? a.clientWidth -
                        b : 0
                }, P = b.getMaximumHeight = function (a) { a = a.parentNode; var b = parseInt(y(a, "padding-bottom")) + parseInt(y(a, "padding-top")); return a ? a.clientHeight - b : 0 }, y = b.getStyle = function (a, b) { return a.currentStyle ? a.currentStyle[b] : document.defaultView.getComputedStyle(a, null).getPropertyValue(b) }, Q = (b.getMaximumSize = b.getMaximumWidth, b.retinaScale = function (a) {
                    var b = a.ctx, f = a.canvas.width; a = a.canvas.height; window.devicePixelRatio && (b.canvas.style.width = f + "px", b.canvas.style.height = a + "px", b.canvas.height = a * window.devicePixelRatio,
                        b.canvas.width = f * window.devicePixelRatio, b.scale(window.devicePixelRatio, window.devicePixelRatio))
                }), R = b.clear = function (a) { a.ctx.clearRect(0, 0, a.width, a.height) }, t = b.fontString = function (a, b, f) { return b + " " + a + "px " + f }, A = b.longestText = function (a, b, f) { a.font = b; var c = 0; return e(f, function (b) { b = a.measureText(b).width; c = b > c ? b : c }), c }, F = b.drawRoundedRectangle = function (a, b, f, e, c, d) {
                    a.beginPath(); a.moveTo(b + d, f); a.lineTo(b + e - d, f); a.quadraticCurveTo(b + e, f, b + e, f + d); a.lineTo(b + e, f + c - d); a.quadraticCurveTo(b + e,
                        f + c, b + e - d, f + c); a.lineTo(b + d, f + c); a.quadraticCurveTo(b, f + c, b, f + c - d); a.lineTo(b, f + d); a.quadraticCurveTo(b, f, b + d, f); a.closePath()
                }; c.instances = {}; c.Type = function (a, b, f) { this.options = b; this.chart = f; this.id = H(); c.instances[this.id] = this; b.responsive && this.resize(); this.initialize.call(this, a) }; k(c.Type.prototype, {
                    initialize: function () { return this }, clear: function () { return R(this.chart), this }, stop: function () { return c.animationService.cancelAnimation(this), this }, resize: function (a) {
                        this.stop(); var b = this.chart.canvas,
                            f = O(this.chart.canvas), e = this.options.maintainAspectRatio ? f / this.chart.aspectRatio : P(this.chart.canvas); return b.width = this.chart.width = f, b.height = this.chart.height = e, Q(this.chart), "function" == typeof a && a.apply(this, Array.prototype.slice.call(arguments, 1)), this
                    }, reflow: m, render: function (a) {
                        (a && this.reflow(), this.options.animation && !a) ? (a = new c.Animation, a.numSteps = this.options.animationSteps, a.easing = this.options.animationEasing, a.render = function (a, f) {
                            var e = f.currentStep / f.numSteps, c = (0, b.easingEffects[f.easing])(e);
                            a.draw(c, e, f.currentStep)
                        }, a.onAnimationProgress = this.options.onAnimationProgress, a.onAnimationComplete = this.options.onAnimationComplete, c.animationService.addAnimation(this, a)) : (this.draw(), this.options.onAnimationComplete.call(this)); return this
                    }, generateLegend: function () { return b.template(this.options.legendTemplate, this) }, destroy: function () {
                        this.stop(); this.clear(); N(this, this.events); var a = this.chart.canvas; a.width = this.chart.width; a.height = this.chart.height; a.style.removeProperty ? (a.style.removeProperty("width"),
                            a.style.removeProperty("height")) : (a.style.removeAttribute("width"), a.style.removeAttribute("height")); delete c.instances[this.id]
                    }, showTooltip: function (a, g) {
                        "undefined" == typeof this.activeElements && (this.activeElements = []); if (function (a) { var b = !1; return a.length !== this.activeElements.length ? b = !0 : (e(a, function (a, f) { a !== this.activeElements[f] && (b = !0) }, this), b) }.call(this, a) || g) {
                            if (this.activeElements = a, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), 0 < a.length) if (this.datasets &&
                                1 < this.datasets.length) {
                                    for (var f, d, h = this.datasets.length - 1; 0 <= h && (f = this.datasets[h].points || this.datasets[h].bars || this.datasets[h].segments, d = G(f, a[0]), -1 === d); h--); var k = [], m = []; f = function (a) {
                                        var f, e, g, c, h, B = [], l = [], u = []; return b.each(this.datasets, function (a) { f = a.points || a.bars || a.segments; f[d] && f[d].hasValue() && B.push(f[d]) }), b.each(B, function (a) {
                                            l.push(a.x); u.push(a.y); k.push(b.template(this.options.multiTooltipTemplate, a)); m.push({
                                                fill: a._saved.fillColor || a.fillColor, stroke: a._saved.strokeColor ||
                                                    a.strokeColor
                                            })
                                        }, this), h = v(u), g = x(u), c = v(l), e = x(l), { x: c > this.chart.width / 2 ? c : e, y: (h + g) / 2 }
                                    }.call(this, d); (new c.MultiTooltip({
                                        x: f.x, y: f.y, xPadding: this.options.tooltipXPadding, yPadding: this.options.tooltipYPadding, xOffset: this.options.tooltipXOffset, fillColor: this.options.tooltipFillColor, textColor: this.options.tooltipFontColor, fontFamily: this.options.tooltipFontFamily, fontStyle: this.options.tooltipFontStyle, fontSize: this.options.tooltipFontSize, titleTextColor: this.options.tooltipTitleFontColor, titleFontFamily: this.options.tooltipTitleFontFamily,
                                        titleFontStyle: this.options.tooltipTitleFontStyle, titleFontSize: this.options.tooltipTitleFontSize, cornerRadius: this.options.tooltipCornerRadius, labels: k, legendColors: m, legendColorBackground: this.options.multiTooltipKeyBackground, title: r(this.options.tooltipTitleTemplate, a[0]), chart: this.chart, ctx: this.chart.ctx, custom: this.options.customTooltips
                                    })).draw()
                            } else e(a, function (a) {
                                var b = a.tooltipPosition(); (new c.Tooltip({
                                    x: Math.round(b.x), y: Math.round(b.y), xPadding: this.options.tooltipXPadding, yPadding: this.options.tooltipYPadding,
                                    fillColor: this.options.tooltipFillColor, textColor: this.options.tooltipFontColor, fontFamily: this.options.tooltipFontFamily, fontStyle: this.options.tooltipFontStyle, fontSize: this.options.tooltipFontSize, caretHeight: this.options.tooltipCaretSize, cornerRadius: this.options.tooltipCornerRadius, text: r(this.options.tooltipTemplate, a), chart: this.chart, custom: this.options.customTooltips
                                })).draw()
                            }, this); return this
                        }
    ...
    c.Element = function (a) { k(this, a); this.initialize.apply(this, arguments); this.save() }; k(c.Element.prototype, {
        initialize: function () { }, restore: function (a) { return a ? e(a, function (a) { this[a] = this._saved[a] }, this) : k(this, this._saved), this }, save: function () { return this._saved = h(this), delete this._saved._saved, this }, update: function (a) { return e(a, function (a, b) { this._saved[b] = this[b]; this[b] = a }, this), this }, transition: function (a, b) { return e(a, function (a, e) { this[e] = (a - this._saved[e]) * b + this._saved[e] }, this), this },
        tooltipPosition: function () { return { x: this.x, y: this.y } }, hasValue: function () { return q(this.value) }
    }); c.Element.extend = n; c.Point = c.Element.extend({ display: !0, inRange: function (a, b) { var e = this.hitDetectionRadius + this.radius; return Math.pow(a - this.x, 2) + Math.pow(b - this.y, 2) < Math.pow(e, 2) }, draw: function () { if (this.display) { var a = this.ctx; a.beginPath(); a.arc(this.x, this.y, this.radius, 0, 2 * Math.PI); a.closePath(); a.strokeStyle = this.strokeColor; a.lineWidth = this.strokeWidth; a.fillStyle = this.fillColor; a.fill(); a.stroke() } } });
    c.Arc = c.Element.extend({
        inRange: function (a, e) { var f = b.getAngleFromPoint(this, { x: a, y: e }), c = f.angle % (2 * Math.PI), d = (2 * Math.PI + this.startAngle) % (2 * Math.PI), h = (2 * Math.PI + this.endAngle) % (2 * Math.PI) || 360, f = f.distance >= this.innerRadius && f.distance <= this.outerRadius; return (d > h ? h >= c || c >= d : c >= d && h >= c) && f }, tooltipPosition: function () { var a = this.startAngle + (this.endAngle - this.startAngle) / 2, b = (this.outerRadius - this.innerRadius) / 2 + this.innerRadius; return { x: this.x + Math.cos(a) * b, y: this.y + Math.sin(a) * b } }, draw: function (a) {
            a =
            this.ctx; a.beginPath(); a.arc(this.x, this.y, 0 > this.outerRadius ? 0 : this.outerRadius, this.startAngle, this.endAngle); a.arc(this.x, this.y, 0 > this.innerRadius ? 0 : this.innerRadius, this.endAngle, this.startAngle, !0); a.closePath(); a.strokeStyle = this.strokeColor; a.lineWidth = this.strokeWidth; a.fillStyle = this.fillColor; a.fill(); a.lineJoin = "bevel"; this.showStroke && a.stroke()
        }
    }); c.Rectangle = c.Element.extend({
        draw: function () {
            var a = this.ctx, b = this.width / 2, e = this.x - b, b = this.x + b, c = this.base - (this.base - this.y), d = this.strokeWidth /
                2; this.showStroke && (e += d, b -= d, c += d); a.beginPath(); a.fillStyle = this.fillColor; a.strokeStyle = this.strokeColor; a.lineWidth = this.strokeWidth; a.moveTo(e, this.base); a.lineTo(e, c); a.lineTo(b, c); a.lineTo(b, this.base); a.fill(); this.showStroke && a.stroke()
        }, height: function () { return this.base - this.y }, inRange: function (a, b) { return a >= this.x - this.width / 2 && a <= this.x + this.width / 2 && b >= this.y && b <= this.base }
    ...
    c.Tooltip = c.Element.extend({
        draw: function () {
            var a = this.chart.ctx; a.font = t(this.fontSize, this.fontStyle, this.fontFamily); this.xAlign = "center"; this.yAlign = "above"; var b = this.caretPadding = 2, e = a.measureText(this.text).width + 2 * this.xPadding, c = this.fontSize + 2 * this.yPadding, d = c + this.caretHeight + b; this.x + e / 2 > this.chart.width ? this.xAlign = "left" : 0 > this.x - e / 2 && (this.xAlign = "right"); 0 > this.y - d && (this.yAlign = "below"); var h = this.x - e / 2, d = this.y - d; if (a.fillStyle = this.fillColor, this.custom) this.custom(this); else {
                switch (this.yAlign) {
                    case "above": a.beginPath();
                    ...
                    case "left": h = this.x - e + (this.cornerRadius + this.caretHeight); break; case "right": h =
                        this.x - (this.cornerRadius + this.caretHeight)
                }F(a, h, d, e, c, this.cornerRadius); a.fill(); a.fillStyle = this.textColor; a.textAlign = "center"; a.textBaseline = "middle"; a.fillText(this.text, h + e / 2, d + c / 2)
            }
        }
    }); c.MultiTooltip = c.Element.extend({
        initialize: function () {
            this.font = t(this.fontSize, this.fontStyle, this.fontFamily); this.titleFont = t(this.titleFontSize, this.titleFontStyle, this.titleFontFamily); this.titleHeight = this.title ? 1.5 * this.titleFontSize : 0; this.height = this.labels.length * this.fontSize + this.fontSize / 2 * (this.labels.length -
                1) + 2 * this.yPadding + this.titleHeight; this.ctx.font = this.titleFont; var a = this.ctx.measureText(this.title).width, b = A(this.ctx, this.font, this.labels) + this.fontSize + 3; this.width = x([b, a]) + 2 * this.xPadding; a = this.height / 2; 0 > this.y - a ? this.y = a : this.y + a > this.chart.height && (this.y = this.chart.height - a); this.x > this.chart.width / 2 ? this.x -= this.xOffset + this.width : this.x += this.xOffset
        }, getLineHeight: function (a) {
            var b = this.y - this.height / 2 + this.yPadding; return 0 === a ? b + this.titleHeight / 3 : b + (1.5 * this.fontSize * (a - 1) + this.fontSize /
                2) + this.titleHeight
        }, draw: function () {
            if (this.custom) this.custom(this); else {
                F(this.ctx, this.x, this.y - this.height / 2, this.width, this.height, this.cornerRadius); var a = this.ctx; a.fillStyle = this.fillColor; a.fill(); a.closePath(); a.textAlign = "left"; a.textBaseline = "middle"; a.fillStyle = this.titleTextColor; a.font = this.titleFont; a.fillText(this.title, this.x + this.xPadding, this.getLineHeight(0)); a.font = this.font; b.each(this.labels, function (b, e) {
                    a.fillStyle = this.textColor; a.fillText(b, this.x + this.xPadding + this.fontSize +
                        3, this.getLineHeight(e + 1)); a.fillStyle = this.legendColorBackground; a.fillRect(this.x + this.xPadding, this.getLineHeight(e + 1) - this.fontSize / 2, this.fontSize, this.fontSize); a.fillStyle = this.legendColors[e].fill; a.fillRect(this.x + this.xPadding, this.getLineHeight(e + 1) - this.fontSize / 2, this.fontSize, this.fontSize)
                }, this)
            }
        }
    }); c.Scale = c.Element.extend({
        initialize: function () { this.fit() }, buildYLabels: function () {
            this.yLabels = []; for (var a = C(this.stepValue), b = 0; b <= this.steps; b++)this.yLabels.push(r(this.templateString,
                { value: (this.min + b * this.stepValue).toFixed(a) })); this.yLabelWidth = this.display && this.showLabels ? A(this.ctx, this.font, this.yLabels) + 10 : 0
        }, addXLabel: function (a) { this.xLabels.push(a); this.valuesCount++; this.fit() }, removeXLabel: function () { this.xLabels.shift(); this.valuesCount--; this.fit() }, fit: function () {
            this.startPoint = this.display ? this.fontSize : 0; this.endPoint = this.display ? this.height - 1.5 * this.fontSize - 5 : this.height; this.startPoint += this.padding; this.endPoint -= this.padding; var a, b = this.endPoint, e = this.endPoint -
                this.startPoint; this.calculateYRange(e); this.buildYLabels(); for (this.calculateXLabelRotation(); e > this.endPoint - this.startPoint;)e = this.endPoint - this.startPoint, a = this.yLabelWidth, this.calculateYRange(e), this.buildYLabels(), a < this.yLabelWidth && (this.endPoint = b, this.calculateXLabelRotation())
        }, calculateXLabelRotation: function () {
            this.ctx.font = this.font; var a, b = this.ctx.measureText(this.xLabels[0]).width; if (this.xScalePaddingRight = this.ctx.measureText(this.xLabels[this.xLabels.length - 1]).width / 2 + 3, this.xScalePaddingLeft =
                b / 2 > this.yLabelWidth ? b / 2 : this.yLabelWidth, this.xLabelRotation = 0, this.display) {
                    var e, c = A(this.ctx, this.font, this.xLabels); this.xLabelWidth = c; for (var d = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6; this.xLabelWidth > d && 0 === this.xLabelRotation || this.xLabelWidth > d && 90 >= this.xLabelRotation && 0 < this.xLabelRotation;)e = Math.cos(z(this.xLabelRotation)), a = e * b, a + this.fontSize / 2 > this.yLabelWidth && (this.xScalePaddingLeft = a + this.fontSize / 2), this.xScalePaddingRight = this.fontSize / 2, this.xLabelRotation++, this.xLabelWidth =
                        e * c; 0 < this.xLabelRotation && (this.endPoint -= Math.sin(z(this.xLabelRotation)) * c + 3)
            } else this.xLabelWidth = 0, this.xScalePaddingLeft = this.xScalePaddingRight = this.padding
        }, calculateYRange: m, drawingArea: function () { return this.startPoint - this.endPoint }, calculateY: function (a) { var b = this.drawingArea() / (this.min - this.max); return this.endPoint - b * (a - this.min) }, calculateX: function (a) {
            var b = (0 < this.xLabelRotation, this.width - (this.xScalePaddingLeft + this.xScalePaddingRight)) / Math.max(this.valuesCount - (this.offsetGridLines ?
                0 : 1), 1); a = b * a + this.xScalePaddingLeft; return this.offsetGridLines && (a += b / 2), Math.round(a)
        }, update: function (a) { b.extend(this, a); this.fit() }, draw: function () {
            var a = this.ctx, c = (this.endPoint - this.startPoint) / this.steps, f = Math.round(this.xScalePaddingLeft); this.display && (a.fillStyle = this.textColor, a.font = this.font, e(this.yLabels, function (e, d) {
                var h = this.endPoint - c * d, k = Math.round(h), m = this.showHorizontalLines; a.textAlign = "right"; a.textBaseline = "middle"; this.showLabels && a.fillText(e, f - 10, h); 0 !== d || m || (m =
                    !0); m && a.beginPath(); 0 < d ? (a.lineWidth = this.gridLineWidth, a.strokeStyle = this.gridLineColor) : (a.lineWidth = this.lineWidth, a.strokeStyle = this.lineColor); k += b.aliasPixel(a.lineWidth); m && (a.moveTo(f, k), a.lineTo(this.width, k), a.stroke(), a.closePath()); a.lineWidth = this.lineWidth; a.strokeStyle = this.lineColor; a.beginPath(); a.moveTo(f - 5, k); a.lineTo(f, k); a.stroke(); a.closePath()
            }, this), e(this.xLabels, function (b, e) {
                var c = this.calculateX(e) + D(this.lineWidth), f = this.calculateX(e - (this.offsetGridLines ? .5 : 0)) + D(this.lineWidth),
        ...
        initialize: function () { this.size = v([this.height, this.width]); this.drawingArea = this.display ? this.size / 2 - (this.fontSize / 2 + this.backdropPaddingY) : this.size / 2 }, calculateCenterOffset: function (a) { return this.drawingArea / (this.max - this.min) * (a - this.min) }, update: function () {
            this.lineArc ? this.drawingArea = this.display ? this.size /
                2 - (this.fontSize / 2 + this.backdropPaddingY) : this.size / 2 : this.setScaleSize(); this.buildYLabels()
        }, buildYLabels: function () { this.yLabels = []; for (var a = C(this.stepValue), b = 0; b <= this.steps; b++)this.yLabels.push(r(this.templateString, { value: (this.min + b * this.stepValue).toFixed(a) })) }, getCircumference: function () { return 2 * Math.PI / this.valuesCount }, setScaleSize: function () {
            var a, b, e, c, d, h, k, m = v([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]); k = this.width; var l = 0; this.ctx.font = t(this.pointLabelFontSize,
                this.pointLabelFontStyle, this.pointLabelFontFamily); for (b = 0; b < this.valuesCount; b++)a = this.getPointPosition(b, m), e = this.ctx.measureText(r(this.templateString, { value: this.labels[b] })).width + 5, 0 === b || b === this.valuesCount / 2 ? (c = e / 2, a.x + c > k && (k = a.x + c, d = b), a.x - c < l && (l = a.x - c, h = b)) : b < this.valuesCount / 2 ? a.x + e > k && (k = a.x + e, d = b) : b > this.valuesCount / 2 && a.x - e < l && (l = a.x - e, h = b); a = l; k = Math.ceil(k - this.width); d = this.getIndexAngle(d); h = this.getIndexAngle(h); d = k / Math.sin(d + Math.PI / 2); h = a / Math.sin(h + Math.PI / 2); d = q(d) ? d :
                    0; h = q(h) ? h : 0; this.drawingArea = m - (h + d) / 2; this.setCenterPoint(h, d)
        }, setCenterPoint: function (a, b) { this.xCenter = (a + this.drawingArea + (this.width - b - this.drawingArea)) / 2; this.yCenter = this.height / 2 }, getIndexAngle: function (a) { return 2 * Math.PI / this.valuesCount * a - Math.PI / 2 }, getPointPosition: function (a, b) { var e = this.getIndexAngle(a); return { x: Math.cos(e) * b + this.xCenter, y: Math.sin(e) * b + this.yCenter } }, draw: function () {
            if (this.display) {
                var a = this.ctx; if (e(this.yLabels, function (b, e) {
                    if (0 < e) {
                        var c; c = this.drawingArea /
                            this.steps * e; var d = this.yCenter - c; if (0 < this.lineWidth) { if (a.strokeStyle = this.lineColor, a.lineWidth = this.lineWidth, this.lineArc) a.beginPath(), a.arc(this.xCenter, this.yCenter, c, 0, 2 * Math.PI); else { a.beginPath(); for (var f = 0; f < this.valuesCount; f++)c = this.getPointPosition(f, this.calculateCenterOffset(this.min + e * this.stepValue)), 0 === f ? a.moveTo(c.x, c.y) : a.lineTo(c.x, c.y) } a.closePath(); a.stroke() } if (this.showLabels) {
                                if (a.font = t(this.fontSize, this.fontStyle, this.fontFamily), this.showLabelBackdrop) c = a.measureText(b).width,
                                    a.fillStyle = this.backdropColor, a.fillRect(this.xCenter - c / 2 - this.backdropPaddingX, d - this.fontSize / 2 - this.backdropPaddingY, c + 2 * this.backdropPaddingX, this.fontSize + 2 * this.backdropPaddingY); a.textAlign = "center"; a.textBaseline = "middle"; a.fillStyle = this.fontColor; a.fillText(b, this.xCenter, d)
                            }
                    }
                }, this), !this.lineArc) {
                    a.lineWidth = this.angleLineWidth; a.strokeStyle = this.angleLineColor; for (var b = this.valuesCount - 1; 0 <= b; b--) {
                        var c = null, d = null; if (0 < this.angleLineWidth && 0 === b % this.angleLineInterval && (c = this.calculateCenterOffset(this.max),
                            d = this.getPointPosition(b, c), a.beginPath(), a.moveTo(this.xCenter, this.yCenter), a.lineTo(d.x, d.y), a.stroke(), a.closePath()), this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
                                null == c && (c = this.calculateCenterOffset(this.max)); null == d && (d = this.getPointPosition(b, c)); var h = this.getPointPosition(0 === b ? this.valuesCount - 1 : b - 1, c), k = this.getPointPosition(b === this.valuesCount - 1 ? 0 : b + 1, c), c = (h.x + d.x) / 2, h = (h.y + d.y) / 2, m = (d.x + k.x) / 2, k = (d.y + k.y) / 2; a.beginPath(); a.moveTo(this.xCenter, this.yCenter);
                            a.lineTo(c, h); a.lineTo(d.x, d.y); a.lineTo(m, k); a.fillStyle = this.backgroundColors[b]; a.fill(); a.closePath()
                        } d = this.getPointPosition(b, this.calculateCenterOffset(this.max) + 5); a.font = t(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily); a.fillStyle = this.pointLabelFontColor; h = this.labels.length; c = this.labels.length / 2; m = c / 2; k = m > b || b > h - m; h = b === m || b === h - m; 0 === b ? a.textAlign = "center" : b === c ? a.textAlign = "center" : c > b ? a.textAlign = "left" : a.textAlign = "right"; h ? a.textBaseline = "middle" : k ? a.textBaseline =
                            "bottom" : a.textBaseline = "top"; a.fillText(this.labels[b], d.x, d.y)
                    }
                }
            }
        }
    }); c.animationService = {
        frameDuration: 17, animations: [], dropFrames: 0, addAnimation: function (a, e) { for (var c = 0; c < this.animations.length; ++c)if (this.animations[c].chartInstance === a) return void (this.animations[c].animationObject = e); this.animations.push({ chartInstance: a, animationObject: e }); 1 == this.animations.length && b.requestAnimFrame.call(window, this.digestWrapper) }, cancelAnimation: function (a) {
            var e = b.findNextWhere(this.animations, function (b) {
                return b.chartInstance ===
                    a
            }); e && this.animations.splice(e, 1)
        }, digestWrapper: function () { c.animationService.startDigest.call(c.animationService) }, startDigest: function () {
            var a = Date.now(), e = 0; 1 < this.dropFrames && (e = Math.floor(this.dropFrames), this.dropFrames -= e); for (var c = 0; c < this.animations.length; c++)null === this.animations[c].animationObject.currentStep && (this.animations[c].animationObject.currentStep = 0), this.animations[c].animationObject.currentStep += 1 + e, this.animations[c].animationObject.currentStep > this.animations[c].animationObject.numSteps &&
            ...
            var b = this, e = function () { var c = []; return b.eachBars(function (b) { c.push(b.value) }), c }; c = {
                ...
                height: this.chart.height, width: this.chart.width, ctx: this.chart.ctx, textColor: this.options.scaleFontColor, fontSize: this.options.scaleFontSize, fontStyle: this.options.scaleFontStyle, fontFamily: this.options.scaleFontFamily, valuesCount: c.length, beginAtZero: this.options.scaleBeginAtZero, integersOnly: this.options.scaleIntegersOnly, calculateYRange: function (b) { b = d.calculateScaleRange(e(), b, this.fontSize, this.beginAtZero, this.integersOnly); d.extend(this, b) }, xLabels: c, font: d.fontString(this.options.scaleFontSize,
                    this.options.scaleFontStyle, this.options.scaleFontFamily), lineWidth: this.options.scaleLineWidth, lineColor: this.options.scaleLineColor, showHorizontalLines: this.options.scaleShowHorizontalLines, showVerticalLines: this.options.scaleShowVerticalLines, gridLineWidth: this.options.scaleShowGridLines ? this.options.scaleGridLineWidth : 0, gridLineColor: this.options.scaleShowGridLines ? this.options.scaleGridLineColor : "rgba(0,0,0,0)", padding: this.options.showScale ? 0 : this.options.barShowStroke ? this.options.barStrokeWidth :
                        0, showLabels: this.options.scaleShowLabels, display: this.options.showScale
            }; this.options.scaleOverride && d.extend(c, { calculateYRange: d.noop, steps: this.options.scaleSteps, stepValue: this.options.scaleStepWidth, min: this.options.scaleStartValue, max: this.options.scaleStartValue + this.options.scaleSteps * this.options.scaleStepWidth }); this.scale = new this.ScaleClass(c)
        }, addData: function (c, b) {
            d.each(c, function (c, d) {
                this.datasets[d].bars.push(new this.BarClass({
                    value: c, label: b, datasetLabel: this.datasets[d].label,
                    x: this.scale.calculateBarX(this.datasets.length, d, this.scale.valuesCount + 1), y: this.scale.endPoint, width: this.scale.calculateBarWidth(this.datasets.length), base: this.scale.endPoint, strokeColor: this.datasets[d].strokeColor, fillColor: this.datasets[d].fillColor
                }))
            }, this); this.scale.addXLabel(b); this.update()
        }, removeData: function () { this.scale.removeXLabel(); d.each(this.datasets, function (c) { c.bars.shift() }, this); this.update() }, reflow: function () {
            d.extend(this.BarClass.prototype, { y: this.scale.endPoint, base: this.scale.endPoint });
            var c = d.extend({ height: this.chart.height, width: this.chart.width }); this.scale.update(c)
        }, draw: function (c) { var b = c || 1; this.clear(); this.chart.ctx; this.scale.draw(b); d.each(this.datasets, function (c, h) { d.each(c.bars, function (c, e) { c.hasValue() && (c.base = this.scale.endPoint, c.transition({ x: this.scale.calculateBarX(this.datasets.length, h, e), y: this.scale.calculateY(c.value), width: this.scale.calculateBarWidth(this.datasets.length) }, b).draw()) }, this) }, this) }
    })
}).call(this);
(function () {
    ...
    l.Type.extend({
        name: "Doughnut", defaults: c, initialize: function (b) {
            this.segments = []; this.outerRadius = (d.min([this.chart.width, this.chart.height]) - this.options.segmentStrokeWidth / 2) / 2; this.SegmentArc = l.Arc.extend({ ctx: this.chart.ctx, x: this.chart.width / 2, y: this.chart.height / 2 }); this.options.showTooltips && d.bindEvents(this, this.options.tooltipEvents, function (b) {
                b = "mouseout" !== b.type ? this.getSegmentsAtEvent(b) : []; d.each(this.segments, function (b) { b.restore(["fillColor"]) }); d.each(b, function (b) {
                    b.fillColor =
                    b.highlightColor
                }); this.showTooltip(b)
            }); this.calculateTotal(b); d.each(b, function (c, d) { c.color || (c.color = "hsl(" + 360 * d / b.length + ", 100%, 50%)"); this.addData(c, d, !0) }, this); this.render()
        }, getSegmentsAtEvent: function (b) { var c = [], h = d.getRelativePosition(b); return d.each(this.segments, function (b) { b.inRange(h.x, h.y) && c.push(b) }, this), c }, addData: function (b, c, d) {
            c = void 0 !== c ? c : this.segments.length; "undefined" == typeof b.color && (b.color = l.defaults.global.segmentColorDefault[c % l.defaults.global.segmentColorDefault.length],
                b.highlight = l.defaults.global.segmentHighlightColorDefaults[c % l.defaults.global.segmentHighlightColorDefaults.length]); this.segments.splice(c, 0, new this.SegmentArc({
...
(function () {
    var l = this.Chart, d = l.helpers; l.Type.extend({
        name: "Line", defaults: {
            ...
            this.PointClass = l.Point.extend({ offsetGridLines: this.options.offsetGridLines, strokeWidth: this.options.pointDotStrokeWidth, radius: this.options.pointDotRadius, display: this.options.pointDot, hitDetectionRadius: this.options.pointHitDetectionRadius, ctx: this.chart.ctx, inRange: function (b) { return Math.pow(b - this.x, 2) < Math.pow(this.radius + this.hitDetectionRadius, 2) } }); this.datasets = []; this.options.showTooltips && d.bindEvents(this, this.options.tooltipEvents, function (b) {
                b =
                "mouseout" !== b.type ? this.getPointsAtEvent(b) : []; this.eachPoints(function (b) { b.restore(["fillColor", "strokeColor"]) }); d.each(b, function (b) { b.fillColor = b.highlightFill; b.strokeColor = b.highlightStroke }); this.showTooltip(b)
            }); d.each(c.datasets, function (b) {
                var e = { label: b.label || null, fillColor: b.fillColor, strokeColor: b.strokeColor, pointColor: b.pointColor, pointStrokeColor: b.pointStrokeColor, points: [] }; this.datasets.push(e); d.each(b.data, function (d, k) {
                    e.points.push(new this.PointClass({
                        value: d, label: c.labels[k],
                        datasetLabel: b.label, strokeColor: b.pointStrokeColor, fillColor: b.pointColor, highlightFill: b.pointHighlightFill || b.pointColor, highlightStroke: b.pointHighlightStroke || b.pointStrokeColor
                    }))
                }, this); this.buildScale(c.labels); this.eachPoints(function (b, c) { d.extend(b, { x: this.scale.calculateX(c), y: this.scale.endPoint }); b.save() }, this)
            }, this); this.render()
        }, update: function () {
            this.scale.update(); d.each(this.activeElements, function (c) { c.restore(["fillColor", "strokeColor"]) }); this.eachPoints(function (c) { c.save() });
            this.render()
        }, eachPoints: function (c) { d.each(this.datasets, function (b) { d.each(b.points, c, this) }, this) }, getPointsAtEvent: function (c) { var b = [], e = d.getRelativePosition(c); return d.each(this.datasets, function (c) { d.each(c.points, function (c) { c.inRange(e.x, e.y) && b.push(c) }) }, this), b }, buildScale: function (c) {
            var b = this, e = function () { var c = []; return b.eachPoints(function (b) { c.push(b.value) }), c }; c = {
            ...
            this.options.scaleOverride && d.extend(c, { calculateYRange: d.noop, steps: this.options.scaleSteps, stepValue: this.options.scaleStepWidth, min: this.options.scaleStartValue, max: this.options.scaleStartValue + this.options.scaleSteps * this.options.scaleStepWidth }); this.scale = new l.Scale(c)
        }, addData: function (c, b) {
            d.each(c, function (c, d) {
                this.datasets[d].points.push(new this.PointClass({
                    value: c, label: b, datasetLabel: this.datasets[d].label, x: this.scale.calculateX(this.scale.valuesCount + 1), y: this.scale.endPoint, strokeColor: this.datasets[d].pointStrokeColor,
                    fillColor: this.datasets[d].pointColor
                }))
            }, this); this.scale.addXLabel(b); this.update()
        }, removeData: function () { this.scale.removeXLabel(); d.each(this.datasets, function (c) { c.points.shift() }, this); this.update() }, reflow: function () { var c = d.extend({ height: this.chart.height, width: this.chart.width }); this.scale.update(c) }, draw: function (c) {
            var b = c || 1; this.clear(); var e = this.chart.ctx, h = function (b) { return null !== b.value }, k = function (b, c, e) { return d.findNextWhere(c, h, e) || b }, l = function (b, c, e) {
                return d.findPreviousWhere(c,
                    h, e) || b
            }; this.scale && (this.scale.draw(b), d.each(this.datasets, function (c) {
                var n = d.where(c.points, h); d.each(c.points, function (c, e) { c.hasValue() && c.transition({ y: this.scale.calculateY(c.value), x: this.scale.calculateX(e) }, b) }, this); this.options.bezierCurve && d.each(n, function (b, c) {
                    var e = 0 < c && c < n.length - 1 ? this.options.bezierCurveTension : 0; b.controlPoints = d.splineCurve(l(b, n, c), b, k(b, n, c), e); b.controlPoints.outer.y > this.scale.endPoint ? b.controlPoints.outer.y = this.scale.endPoint : b.controlPoints.outer.y <
                        this.scale.startPoint && (b.controlPoints.outer.y = this.scale.startPoint); b.controlPoints.inner.y > this.scale.endPoint ? b.controlPoints.inner.y = this.scale.endPoint : b.controlPoints.inner.y < this.scale.startPoint && (b.controlPoints.inner.y = this.scale.startPoint)
                }, this); e.lineWidth = this.options.datasetStrokeWidth; e.strokeStyle = c.strokeColor; e.beginPath(); d.each(n, function (b, c) {
                    if (0 === c) e.moveTo(b.x, b.y); else if (this.options.bezierCurve) {
                        var d = l(b, n, c); e.bezierCurveTo(d.controlPoints.outer.x, d.controlPoints.outer.y,
                            b.controlPoints.inner.x, b.controlPoints.inner.y, b.x, b.y)
                    } else e.lineTo(b.x, b.y)
                }, this); this.options.datasetStroke && e.stroke(); this.options.datasetFill && 0 < n.length && (e.lineTo(n[n.length - 1].x, this.scale.endPoint), e.lineTo(n[0].x, this.scale.endPoint), e.fillStyle = c.fillColor, e.closePath(), e.fill()); d.each(n, function (b) { b.draw() })
            }, this))
        }
    })
}).call(this);
(function () {
    var l = this.Chart, d = l.helpers; l.Type.extend({
        name: "PolarArea", defaults: { scaleShowLabelBackdrop: !0, scaleBackdropColor: "rgba(255,255,255,0.75)", scaleBeginAtZero: !0, scaleBackdropPaddingY: 2, scaleBackdropPaddingX: 2, scaleShowLine: !0, segmentShowStroke: !0, segmentStrokeColor: "#fff", segmentStrokeWidth: 2, animationSteps: 100, animationEasing: "easeOutBounce", animateRotate: !0, animateScale: !1, legendTemplate: '\x3cul class\x3d"\x3c%\x3dname.toLowerCase()%\x3e-legend"\x3e\x3c% for (var i\x3d0; i\x3csegments.length; i++){%\x3e\x3cli\x3e\x3cspan class\x3d"\x3c%\x3dname.toLowerCase()%\x3e-legend-icon" style\x3d"background-color:\x3c%\x3dsegments[i].fillColor%\x3e"\x3e\x3c/span\x3e\x3cspan class\x3d"\x3c%\x3dname.toLowerCase()%\x3e-legend-text"\x3e\x3c%if(segments[i].label){%\x3e\x3c%\x3dsegments[i].label%\x3e\x3c%}%\x3e\x3c/span\x3e\x3c/li\x3e\x3c%}%\x3e\x3c/ul\x3e' },
        initialize: function (c) {
            this.segments = []; this.SegmentArc = l.Arc.extend({ showStroke: this.options.segmentShowStroke, strokeWidth: this.options.segmentStrokeWidth, strokeColor: this.options.segmentStrokeColor, ctx: this.chart.ctx, innerRadius: 0, x: this.chart.width / 2, y: this.chart.height / 2 }); this.scale = new l.RadialScale({
                display: this.options.showScale, fontStyle: this.options.scaleFontStyle, fontSize: this.options.scaleFontSize, fontFamily: this.options.scaleFontFamily, fontColor: this.options.scaleFontColor, showLabels: this.options.scaleShowLabels,
            ...
            var b = [], e = d.getRelativePosition(c); return d.each(this.segments, function (c) {
                c.inRange(e.x,
                    e.y) && b.push(c)
            }, this), b
        }, addData: function (c, b, e) { this.segments.splice(b || this.segments.length, 0, new this.SegmentArc({ fillColor: c.color, highlightColor: c.highlight || c.color, label: c.label, value: c.value, outerRadius: this.options.animateScale ? 0 : this.scale.calculateCenterOffset(c.value), circumference: this.options.animateRotate ? 0 : this.scale.getCircumference(), startAngle: 1.5 * Math.PI })); e || (this.reflow(), this.update()) }, removeData: function (c) {
            c = d.isNumber(c) ? c : this.segments.length - 1; this.segments.splice(c,
                1); this.reflow(); this.update()
        }, calculateTotal: function (c) { this.total = 0; d.each(c, function (b) { this.total += b.value }, this); this.scale.valuesCount = this.segments.length }, updateScaleRange: function (c) {
            var b = []; d.each(c, function (c) { b.push(c.value) }); c = this.options.scaleOverride ? { steps: this.options.scaleSteps, stepValue: this.options.scaleStepWidth, min: this.options.scaleStartValue, max: this.options.scaleStartValue + this.options.scaleSteps * this.options.scaleStepWidth } : d.calculateScaleRange(b, d.min([this.chart.width,
            this.chart.height]) / 2, this.options.scaleFontSize, this.options.scaleBeginAtZero, this.options.scaleIntegersOnly); d.extend(this.scale, c, { size: d.min([this.chart.width, this.chart.height]), xCenter: this.chart.width / 2, yCenter: this.chart.height / 2 })
        }, update: function () { this.calculateTotal(this.segments); d.each(this.segments, function (c) { c.save() }); this.reflow(); this.render() }, reflow: function () {
            d.extend(this.SegmentArc.prototype, { x: this.chart.width / 2, y: this.chart.height / 2 }); this.updateScaleRange(this.segments);
            this.scale.update(); d.extend(this.scale, { xCenter: this.chart.width / 2, yCenter: this.chart.height / 2 }); d.each(this.segments, function (c) { c.update({ outerRadius: this.scale.calculateCenterOffset(c.value) }) }, this)
        }, draw: function (c) {
            var b = c || 1; this.clear(); d.each(this.segments, function (c, d) {
                c.transition({ circumference: this.scale.getCircumference(), outerRadius: this.scale.calculateCenterOffset(c.value) }, b); c.endAngle = c.startAngle + c.circumference; 0 === d && (c.startAngle = 1.5 * Math.PI); d < this.segments.length - 1 && (this.segments[d +
                    1].startAngle = c.endAngle); c.draw()
...
(function () {
    var l = this.Chart, d = l.helpers; l.Type.extend({
        name: "Radar", defaults: { scaleShowLine: !0, angleShowLineOut: !0, scaleShowLabels: !1, scaleBeginAtZero: !0, angleLineColor: "rgba(0,0,0,.1)", angleLineWidth: 1, angleLineInterval: 1, pointLabelFontFamily: "'Arial'", pointLabelFontStyle: "normal", pointLabelFontSize: 10, pointLabelFontColor: "#666", pointDot: !0, pointDotRadius: 3, pointDotStrokeWidth: 1, pointHitDetectionRadius: 20, datasetStroke: !0, datasetStrokeWidth: 2, datasetFill: !0, legendTemplate: '\x3cul class\x3d"\x3c%\x3dname.toLowerCase()%\x3e-legend"\x3e\x3c% for (var i\x3d0; i\x3cdatasets.length; i++){%\x3e\x3cli\x3e\x3cspan class\x3d"\x3c%\x3dname.toLowerCase()%\x3e-legend-icon" style\x3d"background-color:\x3c%\x3ddatasets[i].strokeColor%\x3e"\x3e\x3c/span\x3e\x3cspan class\x3d"\x3c%\x3dname.toLowerCase()%\x3e-legend-text"\x3e\x3c%if(datasets[i].label){%\x3e\x3c%\x3ddatasets[i].label%\x3e\x3c%}%\x3e\x3c/span\x3e\x3c/li\x3e\x3c%}%\x3e\x3c/ul\x3e' },
        initialize: function (c) {
            this.PointClass = l.Point.extend({ strokeWidth: this.options.pointDotStrokeWidth, radius: this.options.pointDotRadius, display: this.options.pointDot, hitDetectionRadius: this.options.pointHitDetectionRadius, ctx: this.chart.ctx }); this.datasets = []; this.buildScale(c); this.options.showTooltips && d.bindEvents(this, this.options.tooltipEvents, function (b) {
                b = "mouseout" !== b.type ? this.getPointsAtEvent(b) : []; this.eachPoints(function (b) { b.restore(["fillColor", "strokeColor"]) }); d.each(b, function (b) {
                    b.fillColor =
                    b.highlightFill; b.strokeColor = b.highlightStroke
                }); this.showTooltip(b)
            }); d.each(c.datasets, function (b) {
                var e = { label: b.label || null, fillColor: b.fillColor, strokeColor: b.strokeColor, pointColor: b.pointColor, pointStrokeColor: b.pointStrokeColor, points: [] }; this.datasets.push(e); d.each(b.data, function (d, k) {
                    var l; this.scale.animation || (l = this.scale.getPointPosition(k, this.scale.calculateCenterOffset(d))); e.points.push(new this.PointClass({
                        value: d, label: c.labels[k], datasetLabel: b.label, x: this.options.animation ?
                            this.scale.xCenter : l.x, y: this.options.animation ? this.scale.yCenter : l.y, strokeColor: b.pointStrokeColor, fillColor: b.pointColor, highlightFill: b.pointHighlightFill || b.pointColor, highlightStroke: b.pointHighlightStroke || b.pointStrokeColor
                    }))
                }, this)
            }, this); this.render()
        }, eachPoints: function (c) { d.each(this.datasets, function (b) { d.each(b.points, c, this) }, this) }, getPointsAtEvent: function (c) {
            c = d.getRelativePosition(c); c = d.getAngleFromPoint({ x: this.scale.xCenter, y: this.scale.yCenter }, c); var b = Math.round((c.angle -
                1.5 * Math.PI) / (2 * Math.PI / this.scale.valuesCount)), e = []; return (b >= this.scale.valuesCount || 0 > b) && (b = 0), c.distance <= this.scale.drawingArea && d.each(this.datasets, function (c) { e.push(c.points[b]) }), e
        }, buildScale: function (c) {
            this.scale = new l.RadialScale({
                display: this.options.showScale, fontStyle: this.options.scaleFontStyle, fontSize: this.options.scaleFontSize, fontFamily: this.options.scaleFontFamily, fontColor: this.options.scaleFontColor, showLabels: this.options.scaleShowLabels, showLabelBackdrop: this.options.scaleShowLabelBackdrop,
                backdropColor: this.options.scaleBackdropColor, backgroundColors: this.options.scaleBackgroundColors, backdropPaddingY: this.options.scaleBackdropPaddingY, backdropPaddingX: this.options.scaleBackdropPaddingX, lineWidth: this.options.scaleShowLine ? this.options.scaleLineWidth : 0, lineColor: this.options.scaleLineColor, angleLineColor: this.options.angleLineColor, angleLineWidth: this.options.angleShowLineOut ? this.options.angleLineWidth : 0, angleLineInterval: this.options.angleLineInterval ? this.options.angleLineInterval :
                    1, pointLabelFontColor: this.options.pointLabelFontColor, pointLabelFontSize: this.options.pointLabelFontSize, pointLabelFontFamily: this.options.pointLabelFontFamily, pointLabelFontStyle: this.options.pointLabelFontStyle, height: this.chart.height, width: this.chart.width, xCenter: this.chart.width / 2, yCenter: this.chart.height / 2, ctx: this.chart.ctx, templateString: this.options.scaleLabel, labels: c.labels, valuesCount: c.datasets[0].data.length
            }); this.scale.setScaleSize(); this.updateScaleRange(c.datasets); this.scale.buildYLabels()
        },
        updateScaleRange: function (c) {
            var b = function () { var b = []; return d.each(c, function (c) { c.data ? b = b.concat(c.data) : d.each(c.points, function (c) { b.push(c.value) }) }), b }(), b = this.options.scaleOverride ? { steps: this.options.scaleSteps, stepValue: this.options.scaleStepWidth, min: this.options.scaleStartValue, max: this.options.scaleStartValue + this.options.scaleSteps * this.options.scaleStepWidth } : d.calculateScaleRange(b, d.min([this.chart.width, this.chart.height]) / 2, this.options.scaleFontSize, this.options.scaleBeginAtZero,
                this.options.scaleIntegersOnly); d.extend(this.scale, b)
        }, addData: function (c, b) { this.scale.valuesCount++; d.each(c, function (c, d) { var k = this.scale.getPointPosition(this.scale.valuesCount, this.scale.calculateCenterOffset(c)); this.datasets[d].points.push(new this.PointClass({ value: c, label: b, datasetLabel: this.datasets[d].label, x: k.x, y: k.y, strokeColor: this.datasets[d].pointStrokeColor, fillColor: this.datasets[d].pointColor })) }, this); this.scale.labels.push(b); this.reflow(); this.update() }, removeData: function () {
            this.scale.valuesCount--;
            this.scale.labels.shift(); d.each(this.datasets, function (c) { c.points.shift() }, this); this.reflow(); this.update()
        }, update: function () { this.eachPoints(function (c) { c.save() }); this.reflow(); this.render() }, reflow: function () { d.extend(this.scale, { width: this.chart.width, height: this.chart.height, size: d.min([this.chart.width, this.chart.height]), xCenter: this.chart.width / 2, yCenter: this.chart.height / 2 }); this.updateScaleRange(this.datasets); this.scale.setScaleSize(); this.scale.buildYLabels() }, draw: function (c) {
            var b =
                c || 1, e = this.chart.ctx; this.clear(); this.scale.draw(); d.each(this.datasets, function (c) {
                    d.each(c.points, function (c, d) { c.hasValue() && c.transition(this.scale.getPointPosition(d, this.scale.calculateCenterOffset(c.value)), b) }, this); e.lineWidth = this.options.datasetStrokeWidth; e.strokeStyle = c.strokeColor; e.beginPath(); d.each(c.points, function (b, c) { 0 === c ? e.moveTo(b.x, b.y) : e.lineTo(b.x, b.y) }, this); e.closePath(); e.stroke(); e.fillStyle = c.fillColor; this.options.datasetFill && e.fill(); d.each(c.points, function (b) {
                        b.hasValue() &&
                        b.draw()
                    })
                }, this)
...
if (typeof document.addEventListener !== 'undefined')
    document.addEventListener('DOMContentLoaded', createCharts); //HACK: Created function instead so it can be called from page
